# 1 "../hal/SC32F1X/src/sc32f1xxx_tim.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 392 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../hal/SC32F1X/src/sc32f1xxx_tim.c" 2
# 27 "../hal/SC32F1X/src/sc32f1xxx_tim.c"
# 1 "../hal/SC32F1X/inc\\sc32f1xxx_tim.h" 1
# 35 "../hal/SC32F1X/inc\\sc32f1xxx_tim.h"
...
# 36 "../hal/SC32F1X/inc\\sc32f1xxx_tim.h" 2
# 1 "../hal/SC32F1X/inc\\sc32.h" 1
# 37 "../hal/SC32F1X/inc\\sc32f1xxx_tim.h" 2
...
# 38 "../hal/SC32F1X/inc\\sc32f1xxx_tim.h" 2
...
# 28 "../hal/SC32F1X/src/sc32f1xxx_tim.c" 2
# 57 "../hal/SC32F1X/src/sc32f1xxx_tim.c"
void TIM_DeInit(TIM_TypeDef * TIMx) {
    ((void)0U);

    if (TIMx == ((TIM_TypeDef *)(((0x40000000UL) + 0x20000) + (0x00000100UL)))) {
        RCC_APB0PeriphResetCmd(RCC_APB0Periph_TIM0, ENABLE);
        RCC_APB0PeriphResetCmd(RCC_APB0Periph_TIM0, DISABLE);
    } else if (TIMx == ((TIM_TypeDef *)(((0x40000000UL) + 0x20000) + (0x00000140UL)))) {
        RCC_APB0PeriphResetCmd(RCC_APB0Periph_TIM1, ENABLE);
        RCC_APB0PeriphResetCmd(RCC_APB0Periph_TIM1, DISABLE);
    }

    else if (TIMx == ((TIM_TypeDef *)(((0x40000000UL) + 0x20000) + (0x00000180UL)))) {
        RCC_APB0PeriphResetCmd(RCC_APB0Periph_TIM2, ENABLE);
        RCC_APB0PeriphResetCmd(RCC_APB0Periph_TIM2, DISABLE);
    }

    else if (TIMx == ((TIM_TypeDef *)(((0x40000000UL) + 0x20000) + (0x000001C0UL)))) {
        RCC_APB0PeriphResetCmd(RCC_APB0Periph_TIM3, ENABLE);
        RCC_APB0PeriphResetCmd(RCC_APB0Periph_TIM3, DISABLE);
    }
# 87 "../hal/SC32F1X/src/sc32f1xxx_tim.c"
    else if (TIMx == ((TIM_TypeDef *)(((0x40000000UL) + 0x21000) + (0x00000100UL)))) {
        RCC_APB1PeriphResetCmd(RCC_APB1Periph_TIM4, ENABLE);
        RCC_APB1PeriphResetCmd(RCC_APB1Periph_TIM4, DISABLE);
    } else if (TIMx == ((TIM_TypeDef *)(((0x40000000UL) + 0x21000) + (0x00000140UL)))) {
        RCC_APB1PeriphResetCmd(RCC_APB1Periph_TIM5, ENABLE);
        RCC_APB1PeriphResetCmd(RCC_APB1Periph_TIM5, DISABLE);
    } else if (TIMx == ((TIM_TypeDef *)(((0x40000000UL) + 0x21000) + (0x00000180UL)))) {
        RCC_APB1PeriphResetCmd(RCC_APB1Periph_TIM6, ENABLE);
        RCC_APB1PeriphResetCmd(RCC_APB1Periph_TIM6, DISABLE);
    } else if (TIMx == ((TIM_TypeDef *)(((0x40000000UL) + 0x21000) + (0x000001C0UL)))) {
        RCC_APB1PeriphResetCmd(RCC_APB1Periph_TIM7, ENABLE);
        RCC_APB1PeriphResetCmd(RCC_APB1Periph_TIM7, DISABLE);
    }

}
# 124 "../hal/SC32F1X/src/sc32f1xxx_tim.c"
void TIM_TIMBaseInit(TIM_TypeDef * TIMx, TIM_TimeBaseInitTypeDef * TIM_TimeBaseInitStruct) {
    ...
    tmpreg &= (uint32_t)~((0x7L << (8U)) | (0x1L << (1U)) | (0x1L << (6U)) | (0x1L << (5U)));
    ...
    tmpreg |=
        (uint32_t)(TIM_TimeBaseInitStruct->TIM_Prescaler | TIM_TimeBaseInitStruct->TIM_CounterMode |
...
# 187 "../hal/SC32F1X/src/sc32f1xxx_tim.c"
void TIM_Cmd(TIM_TypeDef * TIMx, FunctionalState NewState) {
    ...
    if (NewState != DISABLE) {
        ...
        TIMx->TIM_CON |= (0x1L << (7U));
    } else {

        TIMx->TIM_CON &= (uint16_t)~(0x1L << (7U));
    }
}
# 219 "../hal/SC32F1X/src/sc32f1xxx_tim.c"
void TIM_SetCounter(TIM_TypeDef * TIMx, uint32_t Counter) {
...
# 244 "../hal/SC32F1X/src/sc32f1xxx_tim.c"
uint32_t TIM_GetCounter(TIM_TypeDef * TIMx) {
...
# 270 "../hal/SC32F1X/src/sc32f1xxx_tim.c"
void TIM_SetAutoreload(TIM_TypeDef * TIMx, uint16_t Autoreload) {
...
# 295 "../hal/SC32F1X/src/sc32f1xxx_tim.c"
uint16_t TIM_GetAutoreload(TIM_TypeDef * TIMx) {
...
# 329 "../hal/SC32F1X/src/sc32f1xxx_tim.c"
void TIM_SetPerscaler(TIM_TypeDef * TIMx, TIM_Prescaler_TypeDef TIM_Perscaler) {
    ...
    TIMx->TIM_CON &= (uint32_t)(~(0x7L << (8U)));


    TIMx->TIM_CON |= TIM_Perscaler;
}
# 366 "../hal/SC32F1X/src/sc32f1xxx_tim.c"
TIM_Prescaler_TypeDef TIM_GetPrescaler(TIM_TypeDef * TIMx) {

    ((void)0U);


    return (TIM_Prescaler_TypeDef)(TIMx->TIM_CON & (0x7L << (8U)));
}
# 408 "../hal/SC32F1X/src/sc32f1xxx_tim.c"
void TIM_ICInit(TIM_TypeDef * TIMx, TIM_IC_InitTypeDef * TIM_IC_InitStruct) {
    uint16_t tmpreg;
    ...
    tmpreg &= ~((0x1L << (2U)) | (0x1L << (3U)) | (0x1L << (4U)) | (0x1L << (5U)));
# 441 "../hal/SC32F1X/src/sc32f1xxx_tim.c"
...
# 478 "../hal/SC32F1X/src/sc32f1xxx_tim.c"
void TIM_ICCmd(TIM_TypeDef * TIMx, FunctionalState NewState) {
    ...
    if (NewState != DISABLE) {
        ...
        TIMx->TIM_CON |= (0x1L << (0U));
    } else {

        TIMx->TIM_CON &= (uint16_t)~(0x1L << (0U));
    }
}
# 509 "../hal/SC32F1X/src/sc32f1xxx_tim.c"
uint32_t TIM_GetRisingCapture(TIM_TypeDef * TIMx) {
...
# 534 "../hal/SC32F1X/src/sc32f1xxx_tim.c"
uint32_t TIM_GetFailingCapture(TIM_TypeDef * TIMx) {
...
# 577 "../hal/SC32F1X/src/sc32f1xxx_tim.c"
void TIM_PWMInit(TIM_TypeDef * TIMx, TIM_PWM_InitTypeDef * TIM_PWM_InitStruct) {
    uint32_t tmpreg;
# 588 "../hal/SC32F1X/src/sc32f1xxx_tim.c"
    ((void)0U);
    ...
    tmpreg &= (uint32_t)~((0x1L << (14U)) | (0x1L << (13U)) | (0x1L << (12U)) | (0x1L << (11U)));
# 610 "../hal/SC32F1X/src/sc32f1xxx_tim.c"
    {
...
# 657 "../hal/SC32F1X/src/sc32f1xxx_tim.c"
void TIM_PWMSetDuty(TIM_TypeDef * TIMx,
                    TIM_PWMChannel_Typedef TIM_PWMChannel,
                    uint16_t PWM_DutyValue) {
# 677 "../hal/SC32F1X/src/sc32f1xxx_tim.c"
    ((void)0U);
...
# 709 "../hal/SC32F1X/src/sc32f1xxx_tim.c"
uint16_t TIM_PWMGetDuty(TIM_TypeDef * TIMx, TIM_PWMChannel_Typedef TIM_PWMChannel) {
    uint16_t tmpduty = 0;
...
# 760 "../hal/SC32F1X/src/sc32f1xxx_tim.c"
void TIM_ClockOutputCmd(TIM_TypeDef * TIMx, FunctionalState NewState) {
    ...
    if (NewState != DISABLE) {
        ...
        TIMx->TIM_CON |= (0x1L << (15U));
    } else {

        TIMx->TIM_CON &= (uint32_t)~(0x1L << (15U));
    }
}
# 806 "../hal/SC32F1X/src/sc32f1xxx_tim.c"
void TIM_PinRemapConfig(TIM_TypeDef * TIMx, TIM_PinRemap_TypeDef TIM_Remap) {
    uint32_t tmpreg;
    ...
    tmpreg &= (uint32_t)(~(0x1L << (19U)));

    tmpreg |= TIM_Remap;

    TIMx->TIM_CON = tmpreg;
}
# 861 "../hal/SC32F1X/src/sc32f1xxx_tim.c"
void TIM_ITConfig(TIM_TypeDef * TIMx, uint16_t TIM_IT, FunctionalState NewState) {
...
# 899 "../hal/SC32F1X/src/sc32f1xxx_tim.c"
FlagStatus TIM_GetFlagStatus(TIM_TypeDef * TIMx, TIM_Flag_TypeDef TIM_FLAG) {
...
# 934 "../hal/SC32F1X/src/sc32f1xxx_tim.c"
void TIM_ClearFlag(TIM_TypeDef * TIMx, uint16_t TIM_FLAG) {
...
# 966 "../hal/SC32F1X/src/sc32f1xxx_tim.c"
void TIM_DMACmd(TIM_TypeDef * TIMx, uint16_t TIM_DMAReq, FunctionalState NewState) {
