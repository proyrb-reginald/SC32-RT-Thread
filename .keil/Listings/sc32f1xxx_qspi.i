# 1 "../hal/SC32F1X/src/sc32f1xxx_qspi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 392 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../hal/SC32F1X/src/sc32f1xxx_qspi.c" 2
# 27 "../hal/SC32F1X/src/sc32f1xxx_qspi.c"
# 1 "../hal/SC32F1X/inc\\sc32f1xxx_qspi.h" 1
# 35 "../hal/SC32F1X/inc\\sc32f1xxx_qspi.h"
...
# 36 "../hal/SC32F1X/inc\\sc32f1xxx_qspi.h" 2
# 1 "../hal/SC32F1X/inc\\sc32.h" 1
# 37 "../hal/SC32F1X/inc\\sc32f1xxx_qspi.h" 2
...
# 38 "../hal/SC32F1X/inc\\sc32f1xxx_qspi.h" 2
...
void QSPI_DMACmd(QSPI_TypeDef *QSPIx,
                 ...
                 FunctionalState NewState);
# 28 "../hal/SC32F1X/src/sc32f1xxx_qspi.c" 2
# 48 "../hal/SC32F1X/src/sc32f1xxx_qspi.c"
void QSPI_DeInit(QSPI_TypeDef * QSPIx) {
    ((void)0U);

    if (QSPIx == ((QSPI_TypeDef *)(((0x40000000UL) + 0x20000) + (0x00000040UL)))) {

        RCC_APB0PeriphResetCmd(RCC_APB0Periph_QTWI0, ENABLE);

        RCC_APB0PeriphResetCmd(RCC_APB0Periph_QTWI0, DISABLE);
    } else if (QSPIx == ((QSPI_TypeDef *)(((0x40000000UL) + 0x21000) + (0x00000040UL)))) {
...
# 89 "../hal/SC32F1X/src/sc32f1xxx_qspi.c"
void QSPI_Init(QSPI_TypeDef * QSPIx, QSPI_InitTypeDef * QSPI_InitStruct) {
    uint32_t tmpreg;
    ((void)0U);
    ((void)0U);
    ...
    tmpreg &=
        ~((0x1L << (27U)) | (0x0FL << (8U)) | (0x3L << (28U)) |
          (0x3UL << (30UL)) | (0x3L << (22U)) | (0x1L << (24U)) |
          (0x1L << (25U)) | (0x1L << (26U)) | (0x1L << (21U)) |
          (0x1L << (20U)) | (0x1L << (19U)) | (0x1L << (18U)) |
          (0x1L << (17U)) | (0x1L << (16U)) | (0x3L << (13U)) |
          (0x1L << (7U)));
...
# 130 "../hal/SC32F1X/src/sc32f1xxx_qspi.c"
void QSPI_Cmd(QSPI_TypeDef * QSPIx, FunctionalState NewState) {

    ((void)0U);
    if (NewState != DISABLE) {

        QSPIx->QSPI_CON |= (0x1L << (7U));
    } else {

        QSPIx->QSPI_CON &= ~(0x1L << (7U));
    }
}
# 154 "../hal/SC32F1X/src/sc32f1xxx_qspi.c"
void QSPI_SetDataLength(QSPI_TypeDef * QSPIx, QSPI_DWidth_TypeDef QSPI_DWidth) {
    ((void)0U);
...
# 179 "../hal/SC32F1X/src/sc32f1xxx_qspi.c"
void QSPI_LModeSelect(QSPI_TypeDef * QSPIx, QSPI_LMode_TypeDef QSPI_LMode) {
    ((void)0U);
...
# 204 "../hal/SC32F1X/src/sc32f1xxx_qspi.c"
void QSPI_ModeSelect(QSPI_TypeDef * QSPIx, QSPI_Mode_TypeDef QSPI_Mode) {
    ((void)0U);
...
# 237 "../hal/SC32F1X/src/sc32f1xxx_qspi.c"
void QSPI_Write_ComSet(QSPI_TypeDef * QSPIx,
                       QSPI_LMode_TypeDef LMODE,
                       QSPI_DWidth_TypeDef DWIDTH,
                       QSPI_CLKONLY_TypeDef CLKONLY) {
    ...
    tmpreg &= ~((0x3L << (28U)) | (0x3UL << (30UL)) | (0x1L << (21U)));
...
# 270 "../hal/SC32F1X/src/sc32f1xxx_qspi.c"
void QSPI_SendData8(QSPI_TypeDef * QSPIx, uint8_t Data) {
    QSPIx->QSPI_DATA = (uint8_t)Data;
}
# 281 "../hal/SC32F1X/src/sc32f1xxx_qspi.c"
void QSPI_SendData16(QSPI_TypeDef * QSPIx, uint16_t Data) {
    QSPIx->QSPI_DATA = (uint16_t)Data;
}
# 292 "../hal/SC32F1X/src/sc32f1xxx_qspi.c"
void QSPI_SendData32(QSPI_TypeDef * QSPIx, uint32_t Data) {
    QSPIx->QSPI_DATA = (uint32_t)Data;
}
# 304 "../hal/SC32F1X/src/sc32f1xxx_qspi.c"
void QSPI_SendDataFIFO(QSPI_TypeDef * QSPIx, uint32_t * Data, uint16_t length) {
    uint8_t tmpNum;

    ((void)0U);

    if ((QSPIx->QSPI_CON & (0x3L << (28U))) >= QSPI_DWidth_24bit) {
        for (tmpNum = 0; tmpNum < length; tmpNum++) {
            QSPIx->QSPI_DATA = (uint32_t)Data[tmpNum];
        }
    }

    else if ((QSPIx->QSPI_CON & (0x3L << (28U))) == QSPI_DWidth_16bit) {
        for (tmpNum = 0; tmpNum < length; tmpNum++) {
            QSPIx->QSPI_DATA = (uint32_t)(*((uint16_t *)Data + tmpNum));
        }
    }

    else if ((QSPIx->QSPI_CON & (0x3L << (28U))) == QSPI_DWidth_8bit) {
        for (tmpNum = 0; tmpNum < length; tmpNum++) {
            QSPIx->QSPI_DATA = (uint32_t)(*((uint8_t *)Data + tmpNum));
        }
    }
}
# 336 "../hal/SC32F1X/src/sc32f1xxx_qspi.c"
void QSPI_SendMultipleData(QSPI_TypeDef * QSPIx,
                           uint32_t * buf,
                           uint32_t length) {
    uint8_t tmpNum;
    ...
    if ((QSPIx->QSPI_CON & (0x3L << (28U))) >= QSPI_DWidth_24bit) {
        for (tmpNum = 0; tmpNum < length; tmpNum++) {
            ...
            while (QSPI_GetFlagStatus(((QSPI_TypeDef *)(((0x40000000UL) + 0x20000) + (0x00000040UL))), QSPI_Flag_BUSY) == 0)
                ;
        }
    }
        ...
        for (tmpNum = 0; tmpNum < length; tmpNum++) {
            ...
            while (QSPI_GetFlagStatus(((QSPI_TypeDef *)(((0x40000000UL) + 0x20000) + (0x00000040UL))), QSPI_Flag_BUSY))
                ;
        }
    }
...
# 387 "../hal/SC32F1X/src/sc32f1xxx_qspi.c"
void QSPI_Read_ComSet(QSPI_TypeDef * QSPIx,
                      int32_t LMODE,
                      uint32_t DWIDTH,
                      uint32_t length) {
    ...
    QSPIx->QSPI_CON |= (0x1L << (21U));

    QSPIx->QSPI_DL = 0x00;

    QSPIx->QSPI_DL = length;
}
# 422 "../hal/SC32F1X/src/sc32f1xxx_qspi.c"
void QSPI_CLKONLYSet(QSPI_TypeDef * QSPIx, uint32_t CLKONLY) {
...
# 439 "../hal/SC32F1X/src/sc32f1xxx_qspi.c"
uint8_t QSPI_ReceiveData8(QSPI_TypeDef * QSPIx) {

    ((void)0U);
    return (uint8_t)QSPIx->QSPI_DATA;
}
# 452 "../hal/SC32F1X/src/sc32f1xxx_qspi.c"
uint16_t QSPI_ReceiveData16(QSPI_TypeDef * QSPIx) {

    ((void)0U);
    return (uint16_t)QSPIx->QSPI_DATA;
}
# 465 "../hal/SC32F1X/src/sc32f1xxx_qspi.c"
uint32_t QSPI_ReceiveData32(QSPI_TypeDef * QSPIx) {

    ((void)0U);
    return (uint32_t)QSPIx->QSPI_DATA;
}
# 478 "../hal/SC32F1X/src/sc32f1xxx_qspi.c"
void QSPI_Receivelen(QSPI_TypeDef * QSPIx, uint32_t datalen) {

    ((void)0U);
    QSPIx->QSPI_DL = datalen;
}
# 492 "../hal/SC32F1X/src/sc32f1xxx_qspi.c"
void QSPI_ReceiveMultipleData(QSPI_TypeDef * QSPIx,
                              uint32_t * buf,
                              uint32_t length) {
    uint8_t tmpNum;
...
# 539 "../hal/SC32F1X/src/sc32f1xxx_qspi.c"
void QSPI_ReceiveDataFIFO(QSPI_TypeDef * QSPIx,
                          uint32_t * Data,
                          uint16_t length) {
    uint8_t tmpNum;
...
# 594 "../hal/SC32F1X/src/sc32f1xxx_qspi.c"
void QSPI_ITConfig(QSPI_TypeDef * QSPIx,
                   uint32_t QSPI_IT,
                   FunctionalState NewState) {
...
# 627 "../hal/SC32F1X/src/sc32f1xxx_qspi.c"
FlagStatus QSPI_GetFlagStatus(QSPI_TypeDef * QSPIx,
                              QSPI_FLAG_TypeDef QSPI_FLAG) {
...
# 657 "../hal/SC32F1X/src/sc32f1xxx_qspi.c"
void QSPI_ClearFlag(QSPI_TypeDef * QSPIx, uint32_t QSPI_FLAG) {
...
# 677 "../hal/SC32F1X/src/sc32f1xxx_qspi.c"
void QSPI_DMACmd(QSPI_TypeDef * QSPIx,
                 QSPI_DMAReq_TypeDef QSPI_DMAReq,
                 FunctionalState NewState) {
