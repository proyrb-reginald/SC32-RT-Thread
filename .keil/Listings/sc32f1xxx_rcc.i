# 1 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 392 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../hal/SC32F1X/src/sc32f1xxx_rcc.c" 2
# 26 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
# 1 "../hal/SC32F1X/inc\\sc32f1xxx_rcc.h" 1
# 35 "../hal/SC32F1X/inc\\sc32f1xxx_rcc.h"
...
# 36 "../hal/SC32F1X/inc\\sc32f1xxx_rcc.h" 2
...
# 27 "../hal/SC32F1X/src/sc32f1xxx_rcc.c" 2
# 40 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
volatile uint32_t uwTick;
# 61 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
void RCC_DeInit(void) {

    ((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->RCC_KEY = 0x40;


    ((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->RCC_CFG0 = (uint32_t)0x00001040;


    ((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->RCC_CFG1 = (uint32_t)0x00000000;
    ...
    ((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->NMI_CFG = (uint32_t)0x00000000;
}
# 91 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
ErrorStatus RCC_Unlock(uint8_t TimeLimit) {
    if (TimeLimit >= 0x40) {
        ((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->RCC_KEY = TimeLimit;
        return SUCCESS;
    } else {
        return ERROR;
    }
}
# 107 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
void RCC_HXTCmd(FunctionalState NewState) {
    RCC_Unlock(0xFF);
    if (NewState != DISABLE) {

        ((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->RCC_CFG0 |= (0x1UL << (5U));
    } else {

        ((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->RCC_CFG0 &= (uint32_t)~((uint32_t)(0x1UL << (5U)));
    }
}
# 125 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
void RCC_HIRCCmd(FunctionalState NewState) {
    RCC_Unlock(0xFF);
    if (NewState != DISABLE) {

        ((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->RCC_CFG0 |= (0x1UL << (6U));
    } else {

        ((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->RCC_CFG0 &= (uint32_t)~((uint32_t)(0x1UL << (6U)));
    }
}
# 143 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
void RCC_LXTCmd(FunctionalState NewState) {
    RCC_Unlock(0xFF);
    if (NewState != DISABLE) {

        ((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->RCC_CFG0 |= (0x1UL << (0U));
    } else {

        ((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->RCC_CFG0 &= (uint32_t)~((uint32_t)(0x1UL << (0U)));
    }
}
# 161 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
void RCC_LIRCCmd(FunctionalState NewState) {
    RCC_Unlock(0xFF);
    if (NewState != DISABLE) {

        ((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->RCC_CFG0 |= (0x1UL << (1U));
    } else {

        ((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->RCC_CFG0 &= (uint32_t)~((uint32_t)(0x1UL << (1U)));
    }
}
# 223 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
void RCC_HIRCDIV1Cmd(FunctionalState NewState) {
    RCC_Unlock(0xFF);
    if (NewState != DISABLE) {

        ((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->RCC_CFG0 |= (0x1UL << (14U));
    } else {

        ((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->RCC_CFG0 &= (uint32_t)~((uint32_t)(0x1UL << (14U)));
    }
}
# 241 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
void RCC_APB0Cmd(FunctionalState NewState) {

    ((void)0U);

    if (NewState != DISABLE) {
        ((RCCAPB0_TypeDef *)(((0x40000000UL) + 0x20000) + (0x00000000UL)))->APB0_CFG |= (0x1UL << (23U));
    } else {
        ((RCCAPB0_TypeDef *)(((0x40000000UL) + 0x20000) + (0x00000000UL)))->APB0_CFG &= ~(0x1UL << (23U));
    }
}
# 259 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
void RCC_APB1Cmd(FunctionalState NewState) {

    ((void)0U);

    if (NewState != DISABLE) {
        ((RCCAPB1_TypeDef *)(((0x40000000UL) + 0x21000) + (0x00000000UL)))->APB1_CFG |= (0x1UL << (23U));
    } else {
        ((RCCAPB1_TypeDef *)(((0x40000000UL) + 0x21000) + (0x00000000UL)))->APB1_CFG &= ~(0x1UL << (23U));
    }
}
# 277 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
void RCC_APB2Cmd(FunctionalState NewState) {

    ((void)0U);

    if (NewState != DISABLE) {
        ((RCCAPB2_TypeDef *)(((0x40000000UL) + 0x22000) + (0x00000000UL)))->APB2_CFG |= (0x1UL << (23U));
    } else {
        ((RCCAPB2_TypeDef *)(((0x40000000UL) + 0x22000) + (0x00000000UL)))->APB2_CFG &= ~(0x1UL << (23U));
    }
}
# 350 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
ErrorStatus RCC_SYSCLKConfig(RCC_SYSCLKSource_TypeDef RCC_SYSCLKSource) {
    uint32_t tmpreg;
    RCC_Unlock(0xFF);
    ...
    tmpreg = ((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->RCC_CFG0;

    tmpreg &= (uint32_t)~(0x3UL << (12U));

    tmpreg |= (uint32_t)RCC_WAIT_3;

    ((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->RCC_CFG0 = tmpreg;

    if (RCC_SYSCLKSource != ((uint16_t)(~(0x1UL << (7U))))) {
        RCC_Unlock(0xFF);

        tmpreg = ((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->RCC_CFG0;

        tmpreg &= (uint32_t)~((0x3UL << (8U)) | (0x1UL << (7U)));

        tmpreg |= (uint32_t)RCC_SYSCLKSource;

        ((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->RCC_CFG0 = tmpreg;

        ((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->RCC_CFG0 |= (0x1UL << (7U));

        if ((((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->RCC_CFG0 & (0x1UL << (7U))) != RESET) {
...
# 399 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
            return SUCCESS;
        }
        ...
        ((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->RCC_CFG0 &= (uint32_t)~(0x1UL << (7U));
...
# 440 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
RCC_SYSCLKSource_TypeDef RCC_GetSYSCLKSource(void) {
    if ((((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->RCC_CFG0 & (0x1UL << (7U))) != RESET) {
        return ((RCC_SYSCLKSource_TypeDef)(((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->RCC_CFG0 & (0x3UL << (8U))));
    } else {
...
# 463 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
void RCC_HCLKConfig(RCC_HCLK_TypeDef RCC_HCLK) {

    ((void)0U);

    ((RCCAHB_TypeDef *)(((0x40000000UL)) + (0x00003000UL)))->AHB_CFG &= (uint32_t)~((0x7UL << (20U)));
    ((RCCAHB_TypeDef *)(((0x40000000UL)) + (0x00003000UL)))->AHB_CFG |= RCC_HCLK;
}
# 484 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
void RCC_APB0Config(RCC_PCLK_TypeDef RCC_APB0CLK) {

    ((void)0U);

    ((RCCAPB0_TypeDef *)(((0x40000000UL) + 0x20000) + (0x00000000UL)))->APB0_CFG &= ~((uint32_t)(0x7UL << (20U)));
    ((RCCAPB0_TypeDef *)(((0x40000000UL) + 0x20000) + (0x00000000UL)))->APB0_CFG |= RCC_APB0CLK;
}
# 505 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
void RCC_APB1Config(RCC_PCLK_TypeDef RCC_APB1CLK) {

    ((void)0U);

    ((RCCAPB1_TypeDef *)(((0x40000000UL) + 0x21000) + (0x00000000UL)))->APB1_CFG &= ~((uint32_t)(0x7UL << (20U)));
    ((RCCAPB1_TypeDef *)(((0x40000000UL) + 0x21000) + (0x00000000UL)))->APB1_CFG |= RCC_APB1CLK;
}
# 526 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
void RCC_APB2Config(RCC_PCLK_TypeDef RCC_APB2CLK) {

    ((void)0U);

    ((RCCAPB2_TypeDef *)(((0x40000000UL) + 0x22000) + (0x00000000UL)))->APB2_CFG &= ~((uint32_t)(0x7UL << (20U)));
    ((RCCAPB2_TypeDef *)(((0x40000000UL) + 0x22000) + (0x00000000UL)))->APB2_CFG |= RCC_APB2CLK;
}
...
void RCC_GetClocksFreq(RCC_ClocksTypeDef * RCC_Clocks) {
    ...
    if ((((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->RCC_CFG0 & (0x1UL << (7U))) == RESET) {
        ...
        RCC_Clocks->SYSCLK_Frequency = ((uint32_t)64000000) / 2;

    } else {
        switch (((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->RCC_CFG0 & (0x3UL << (8U))) {

            case RCC_SYSCLKSource_HXT:
                RCC_Clocks->SYSCLK_Frequency = ((uint32_t)16000000);
                break;

            case RCC_SYSCLKSource_LIRC:
                RCC_Clocks->SYSCLK_Frequency = ((uint32_t)32000);
                break;
            case RCC_SYSCLKSource_LXT:
                RCC_Clocks->SYSCLK_Frequency = ((uint32_t)32768);
                break;


            case RCC_SYSCLKSource_HIRC:
                RCC_Clocks->SYSCLK_Frequency = ((uint32_t)64000000);
                break;
# 588 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
        }
    }


    tmp = ((((RCCAHB_TypeDef *)(((0x40000000UL)) + (0x00003000UL)))->AHB_CFG & (0x7UL << (20U))) >> (20U));
    RCC_Clocks->HCLK_Frequency = RCC_Clocks->SYSCLK_Frequency >> tmp;


    tmp = ((((RCCAPB0_TypeDef *)(((0x40000000UL) + 0x20000) + (0x00000000UL)))->APB0_CFG & (0x7UL << (20U))) >> (20U));
    RCC_Clocks->PCLK0_Frequency = RCC_Clocks->HCLK_Frequency >> tmp;


    tmp = ((((RCCAPB1_TypeDef *)(((0x40000000UL) + 0x21000) + (0x00000000UL)))->APB1_CFG & (0x7UL << (20U))) >> (20U));
    RCC_Clocks->PCLK1_Frequency = RCC_Clocks->HCLK_Frequency >> tmp;


    tmp = ((((RCCAPB2_TypeDef *)(((0x40000000UL) + 0x22000) + (0x00000000UL)))->APB2_CFG & (0x7UL << (20U))) >> (20U));
    RCC_Clocks->PCLK2_Frequency = RCC_Clocks->HCLK_Frequency >> tmp;
}
# 617 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
void RCC_WaitConfig(RCC_Wait_TypeDef RCC_Wait) {
    RCC_Unlock(0xFF);

    ((void)0U);

    ((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->RCC_CFG0 &= ~(0x3UL << (12U));
    ((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->RCC_CFG0 |= RCC_Wait;
}
# 644 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
void RCC_PWM0CLKConfig(RCC_PWM0CLKSource_TypeDef RCC_PWM0CLKSource) {
    RCC_Unlock(0xFF);

    ((void)0U);

    ((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->RCC_CFG1 &= ~((uint32_t)(0x1UL << (2U)));
    ((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->RCC_CFG1 |= (uint32_t)(RCC_PWM0CLKSource);
}
# 662 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
void RCC_LCDLEDCLKConfig(RCC_LCDLEDCLKSource_TypeDef RCC_LCDLEDCLKSource) {
    RCC_Unlock(0xFF);

    ((void)0U);

    ((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->RCC_CFG1 &= ~((uint32_t)(0x1UL << (1U)));
    ((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->RCC_CFG1 |= (uint32_t)(RCC_LCDLEDCLKSource);
}
# 678 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
void RCC_BTMCLKConfig(RCC_BTMCLKSource_TypeDef RCC_BTMCLKSource) {
    RCC_Unlock(0xFF);

    ((void)0U);

    ((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->RCC_CFG1 &= ~((uint32_t)(0x1UL << (0U)));
    ((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->RCC_CFG1 |= (uint32_t)(RCC_BTMCLKSource);
}
# 707 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
void RCC_AHBPeriphClockCmd(uint32_t RCC_AHBPeriph, FunctionalState NewState) {

    ((void)0U);

    if (NewState != DISABLE) {
        ((RCCAHB_TypeDef *)(((0x40000000UL)) + (0x00003000UL)))->AHB_CFG |= RCC_AHBPeriph;
    } else {
        ((RCCAHB_TypeDef *)(((0x40000000UL)) + (0x00003000UL)))->AHB_CFG &= ~RCC_AHBPeriph;
    }
}
# 747 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
void RCC_APB0PeriphClockCmd(uint32_t RCC_APB0Periph, FunctionalState NewState) {

    ((void)0U);

    if (NewState != DISABLE) {
        ((RCCAPB0_TypeDef *)(((0x40000000UL) + 0x20000) + (0x00000000UL)))->APB0_CFG |= RCC_APB0Periph;
    } else {
        ((RCCAPB0_TypeDef *)(((0x40000000UL) + 0x20000) + (0x00000000UL)))->APB0_CFG &= ~RCC_APB0Periph;
    }
}
# 786 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
void RCC_APB1PeriphClockCmd(uint32_t RCC_APB1Periph, FunctionalState NewState) {

    ((void)0U);

    if (NewState != DISABLE) {
        ((RCCAPB1_TypeDef *)(((0x40000000UL) + 0x21000) + (0x00000000UL)))->APB1_CFG |= RCC_APB1Periph;
    } else {
        ((RCCAPB1_TypeDef *)(((0x40000000UL) + 0x21000) + (0x00000000UL)))->APB1_CFG &= ~RCC_APB1Periph;
    }
}
# 819 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
void RCC_APB2PeriphClockCmd(uint32_t RCC_APB2Periph, FunctionalState NewState) {

    ((void)0U);

    if (NewState != DISABLE) {
        ((RCCAPB2_TypeDef *)(((0x40000000UL) + 0x22000) + (0x00000000UL)))->APB2_CFG |= RCC_APB2Periph;
    } else {
        ((RCCAPB2_TypeDef *)(((0x40000000UL) + 0x22000) + (0x00000000UL)))->APB2_CFG &= ~RCC_APB2Periph;
    }
}
# 850 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
void RCC_AHBPeriphResetCmd(uint32_t RCC_AHBPeriph, FunctionalState NewState) {

    ((void)0U);

    if (NewState != DISABLE) {
        ((RCCAHB_TypeDef *)(((0x40000000UL)) + (0x00003000UL)))->AHB_RST |= RCC_AHBPeriph;
    } else {
        ((RCCAHB_TypeDef *)(((0x40000000UL)) + (0x00003000UL)))->AHB_RST &= ~RCC_AHBPeriph;
    }
}
# 890 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
void RCC_APB0PeriphResetCmd(uint32_t RCC_APB0Periph, FunctionalState NewState) {

    ((void)0U);

    if (NewState != DISABLE) {
        ((RCCAPB0_TypeDef *)(((0x40000000UL) + 0x20000) + (0x00000000UL)))->APB0_RST |= RCC_APB0Periph;
    } else {
        ((RCCAPB0_TypeDef *)(((0x40000000UL) + 0x20000) + (0x00000000UL)))->APB0_RST &= ~RCC_APB0Periph;
    }
}
# 929 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
void RCC_APB1PeriphResetCmd(uint32_t RCC_APB1Periph, FunctionalState NewState) {

    ((void)0U);

    if (NewState != DISABLE) {
        ((RCCAPB1_TypeDef *)(((0x40000000UL) + 0x21000) + (0x00000000UL)))->APB1_RST |= RCC_APB1Periph;
    } else {
        ((RCCAPB1_TypeDef *)(((0x40000000UL) + 0x21000) + (0x00000000UL)))->APB1_RST &= ~RCC_APB1Periph;
    }
}
# 962 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
void RCC_APB2PeriphResetCmd(uint32_t RCC_APB2Periph, FunctionalState NewState) {

    ((void)0U);

    if (NewState != DISABLE) {
        ((RCCAPB2_TypeDef *)(((0x40000000UL) + 0x22000) + (0x00000000UL)))->APB2_RST |= RCC_APB2Periph;
    } else {
        ((RCCAPB2_TypeDef *)(((0x40000000UL) + 0x22000) + (0x00000000UL)))->APB2_RST &= ~RCC_APB2Periph;
    }
}
# 999 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
void RCC_NMICmd(uint32_t RCC_NMIPeriph, FunctionalState NewState) {
    uint32_t temp;

    ((void)0U);

    temp = ((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->NMI_CFG;
...
# 1039 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
void RCC_SystickCLKConfig(RCC_SysTickSource_TypeDef RCC_SysTickSource) {
    ...
    if (RCC_SysTickSource == RCC_SysTickSource_HCLK) {
        ...
        RCC_Unlock(0xFF);
        ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL &= ~(1UL << 2U);
        ((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->RCC_CFG1 &= ~((uint32_t)(0x3UL << (5U)));
        ((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->RCC_CFG1 |= (uint32_t)(RCC_SysTickSource);
    }
}
...
void RCC_SystickSetCounter(uint32_t Counter) {
    if ((Counter - 1UL) <= (0xFFFFFFUL ))
    {
        ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->LOAD = (uint32_t)(Counter - 1UL);
        ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->VAL = 0UL;
    }
}
...
void RCC_SystickCmd(FunctionalState NewState) {
    ...
    if (NewState != DISABLE) {
        ...
        ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL &= ~(uint32_t)((1UL ) | (1UL << 1U));
    }
}
...
FlagStatus RCC_SystickGetFlagStatus(void) {
    if ((((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL & (1UL << 16U)) != (uint32_t)RESET) {
        return (SET);
    }
    return (RESET);
}
# 1120 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
void RCC_ITConfig(FunctionalState NewState) {
    RCC_Unlock(0xFF);
    if (NewState != DISABLE) {
        ((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->RCC_CFG0 |= (0x1UL << (15U));
    } else {
        ((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->RCC_CFG0 &= (uint32_t)~((uint32_t)(0x1UL << (15U)));
    }
}
# 1145 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
FlagStatus RCC_GetFlagStatus(uint32_t RCC_FLAG) {

    ((void)0U);

    if ((((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->RCC_STS & RCC_FLAG) != (uint32_t)RESET) {
        return (SET);
    }
    return (RESET);
}
# 1162 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
void RCC_ClearFlag(uint32_t RCC_FLAG) {

    ((void)0U);


    ((RCC_TypeDef *)(((0x40000000UL)) + (0x0000300CUL)))->RCC_STS |= (uint32_t)RCC_FLAG;
}
# 1193 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
void SC_IncTick(void) {
    uwTick++;
}
# 1207 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
void SC_Delay(uint32_t ms_Delay) {
...
# 1236 "../hal/SC32F1X/src/sc32f1xxx_rcc.c"
void SC_Delay_us(uint32_t us_Delay, uint32_t Sys_freq) {
    if (us_Delay < 0xFFFFFFFFU && us_Delay >= 10) {
        ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->LOAD = (uint32_t)((us_Delay - 2) * (Sys_freq / 1000000));
        ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->VAL = 0UL;
        uint32_t tickstart = uwTick;
