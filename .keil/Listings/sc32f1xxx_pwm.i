# 1 "../hal/SC32F1X/src/sc32f1xxx_pwm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 392 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../hal/SC32F1X/src/sc32f1xxx_pwm.c" 2
# 28 "../hal/SC32F1X/src/sc32f1xxx_pwm.c"
# 1 "../hal/SC32F1X/inc\\sc32f1xxx_pwm.h" 1
# 35 "../hal/SC32F1X/inc\\sc32f1xxx_pwm.h"
...
# 36 "../hal/SC32F1X/inc\\sc32f1xxx_pwm.h" 2
# 1 "../hal/SC32F1X/inc\\sc32.h" 1
# 37 "../hal/SC32F1X/inc\\sc32f1xxx_pwm.h" 2
...
# 38 "../hal/SC32F1X/inc\\sc32f1xxx_pwm.h" 2
...
# 29 "../hal/SC32F1X/src/sc32f1xxx_pwm.c" 2
# 47 "../hal/SC32F1X/src/sc32f1xxx_pwm.c"
void PWM_DeInit(PWM_TypeDef * PWMx) {

    ((void)0U);

    if (PWMx == ((PWM_TypeDef *)(((0x40000000UL) + 0x20000) + (0x00000200UL)))) {
...
# 82 "../hal/SC32F1X/src/sc32f1xxx_pwm.c"
void PWM_Init(PWM_TypeDef * PWMx, PWM_InitTypeDef * PWM_InitStruct) {
    uint32_t tmpreg;
    ...
    tmpreg &= (uint32_t)~((0x7L << (0U)) | (0x1L << (6U)) | (0x1L << (5U)));
...
# 119 "../hal/SC32F1X/src/sc32f1xxx_pwm.c"
void PWM_RisingDeadTimeConfig(PWM_TypeDef * PWMx, uint8_t PWM_RisingDeadTime) {
    uint32_t tmpreg;
    ...
    tmpreg &= (uint32_t)~((0x0FL << (0U)));


    tmpreg |= (uint32_t)(PWM_RisingDeadTime << (0U));


    PWMx->PWM_DFR = tmpreg;
}
# 144 "../hal/SC32F1X/src/sc32f1xxx_pwm.c"
void PWM_FallingDeadTimeConfig(PWM_TypeDef * PWMx, uint8_t PWM_FallingDeadTime) {
    uint32_t tmpreg;
    ...
    tmpreg &= (uint32_t)~((0x0FL << (8U)));


    tmpreg |= (uint32_t)(PWM_FallingDeadTime << (8U));


    PWMx->PWM_DFR = tmpreg;
}
# 171 "../hal/SC32F1X/src/sc32f1xxx_pwm.c"
void PWM_Cmd(PWM_TypeDef * PWMx, FunctionalState NewState) {
    ...
    if (NewState != DISABLE) {
        ...
        PWMx->PWM_CON |= (0x1L << (7U));
    } else {

        PWMx->PWM_CON &= (uint16_t)~(0x1L << (7U));
    }
}
# 200 "../hal/SC32F1X/src/sc32f1xxx_pwm.c"
void PWM_SetPrescaler(PWM_TypeDef * PWMx, PWM_Prescaler_TypeDef PWM_Prescaler) {
    ...
    PWMx->PWM_CON &= (uint16_t)~((0x7L << (0U)));


    PWMx->PWM_CON |= PWM_Prescaler;
}
# 226 "../hal/SC32F1X/src/sc32f1xxx_pwm.c"
PWM_Prescaler_TypeDef PWM_GetPrescaler(PWM_TypeDef * PWMx) {

    ((void)0U);


    return (PWM_Prescaler_TypeDef)(PWMx->PWM_CON & (0x7L << (0U)));
}
# 241 "../hal/SC32F1X/src/sc32f1xxx_pwm.c"
void PWM_SetCycle(PWM_TypeDef * PWMx, uint32_t PWM_Cycle) {
...
# 281 "../hal/SC32F1X/src/sc32f1xxx_pwm.c"
void PWM_SetDuty(PWM_TypeDef * PWMx, PWM_Channel_Typedef PWM_Channel, uint16_t PWM_Duty) {
    uint8_t tmpvalue;
    uint32_t tmpchannel;
...
# 314 "../hal/SC32F1X/src/sc32f1xxx_pwm.c"
uint16_t PWM_GetDuty(PWM_TypeDef * PWMx, PWM_Channel_Typedef PWM_Channel) {
    uint8_t tmpvalue;
    uint32_t tmpchannel;
...
# 352 "../hal/SC32F1X/src/sc32f1xxx_pwm.c"
void PWM_FDStructInit(PWM_FDInitTypeDef * PWM_FDInitStruct) {
...
# 366 "../hal/SC32F1X/src/sc32f1xxx_pwm.c"
void PWM_FDInit(PWM_TypeDef * PWMx, PWM_FDInitTypeDef * PWM_FDInitStruct) {
    ((void)0U);

    PWMx->PWM_FLT &= (uint32_t)~((0x03L << (0U)) | (0x1L << (4U)) | (0x1L << (5U)));
    PWMx->PWM_FLT |= (uint32_t)(PWM_FDInitStruct->PWM_FDFilteringTime |
                                PWM_FDInitStruct->PWM_FDMode | PWM_FDInitStruct->PWM_FDVoltage);
}
# 383 "../hal/SC32F1X/src/sc32f1xxx_pwm.c"
void PWM_FDCmd(PWM_TypeDef * PWMx, FunctionalState NewState) {
    ...
    if (NewState != DISABLE) {
        ...
        PWMx->PWM_FLT |= (0x1L << (7U));
    } else {

        PWMx->PWM_FLT &= (uint16_t)~(0x1L << (7U));
    }
}
# 422 "../hal/SC32F1X/src/sc32f1xxx_pwm.c"
void PWM_ITConfig(PWM_TypeDef * PWMx, uint16_t PWM_IT, FunctionalState NewState) {
...
# 447 "../hal/SC32F1X/src/sc32f1xxx_pwm.c"
FlagStatus PWM_GetFlagStatus(PWM_TypeDef * PWMx, uint16_t PWM_FLAG) {
...
# 470 "../hal/SC32F1X/src/sc32f1xxx_pwm.c"
void PWM_ClearFlag(PWM_TypeDef * PWMx, uint16_t PWM_FLAG) {
