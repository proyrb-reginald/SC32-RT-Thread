# 1 "../hal/SC32F1X/src/sc32f1xxx_op.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 392 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../hal/SC32F1X/src/sc32f1xxx_op.c" 2
# 28 "../hal/SC32F1X/src/sc32f1xxx_op.c"
# 1 "../hal/SC32F1X/inc\\sc32f1xxx_op.h" 1
# 35 "../hal/SC32F1X/inc\\sc32f1xxx_op.h"
# 1 "../hal/SC32F1X/inc\\sc32.h" 1
# 42 "../hal/SC32F1X/inc\\sc32.h"
...
# 43 "../hal/SC32F1X/inc\\sc32.h" 2
# 36 "../hal/SC32F1X/inc\\sc32f1xxx_op.h" 2
...
# 37 "../hal/SC32F1X/inc\\sc32f1xxx_op.h" 2
...
# 29 "../hal/SC32F1X/src/sc32f1xxx_op.c" 2
# 52 "../hal/SC32F1X/src/sc32f1xxx_op.c"
void OP_DeInit(OP_TypeDef * OPx) {
    ...
    if (OPx == ((OP_TypeDef *)(((0x40000000UL) + 0x22000) + (0x00000140UL)))) {
...
# 84 "../hal/SC32F1X/src/sc32f1xxx_op.c"
}
# 99 "../hal/SC32F1X/src/sc32f1xxx_op.c"
void OP_Init(OP_TypeDef * OPx, OP_InitTypeDef * OP_InitStruct) {
    ...
    tmpreg &= (uint32_t)~((0x1L << (1U)) | (0x1L << (3U)) | (0x7L << (5U)) | (0x3L << (8U)) |
                          (0x3FL << (12U)) | (0x1L << (23U)));
    ...
    OPx->OP_CON = tmpreg;
# 178 "../hal/SC32F1X/src/sc32f1xxx_op.c"
}
# 214 "../hal/SC32F1X/src/sc32f1xxx_op.c"
void OP_Cmd(OP_TypeDef * OPx, FunctionalState NewState) {
    ...
    if (NewState != DISABLE) {
        ...
        OPx->OP_CON &= (uint16_t)~(0x1L << (0U));
    }
# 253 "../hal/SC32F1X/src/sc32f1xxx_op.c"
}
# 269 "../hal/SC32F1X/src/sc32f1xxx_op.c"
void OP_OffsetTrimConfig(OP_TypeDef * OPx, uint32_t OP_TrimValueH, uint32_t OP_TrimValueL) {
    ...
    tmpreg &= (uint32_t)~(((0x1FL << (16U)) | (0x1FL << (24U))));


    tmpreg |= (uint32_t)((OP_TrimValueL << (16U)) |
                         (OP_TrimValueH << (24U)));


    OPx->OP_CON = tmpreg;
# 333 "../hal/SC32F1X/src/sc32f1xxx_op.c"
}
# 359 "../hal/SC32F1X/src/sc32f1xxx_op.c"
void OP_GainSelection(OP_TypeDef * OPx, OP_PGAGain_TypeDef PGAGain) {
    ...
    OPx->OP_CON &= ~((0x3L << (8U)));
    OPx->OP_CON |= PGAGain;
# 383 "../hal/SC32F1X/src/sc32f1xxx_op.c"
}
# 403 "../hal/SC32F1X/src/sc32f1xxx_op.c"
void OP_OutputSelection(OP_TypeDef * OPx, OP_Output_TypeDef OPOutput) {
    ...
    OPx->OP_CON &= ~((0x1L << (1U)));
    OPx->OP_CON |= OPOutput;
# 427 "../hal/SC32F1X/src/sc32f1xxx_op.c"
}
...
ErrorStatus OP_OffsetSet(OP_TypeDef * OPx) {
    ...
    OPx_offsetchecksum0 = (*((uint8_t *)0X08C00000 + 0x480)) + (*((uint8_t *)0X08C00000 + 0x481)) +
    ...
    if ((OPx_Readoffset0 == 0x55) && (OPx_Readoffset2 == 0x55) &&
        ...
        tmpreg &= (uint32_t)~(((0x1FL << (24U)) | (0x1FL << (16U))));


        tmpreg |= (uint32_t)((OPx_Readoffset3 << (24U)) |
                             (OPx_Readoffset1 << (16U)));
