# 1 "../hal/SC32F1X/src/sc32f1xxx_dma.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 392 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../hal/SC32F1X/src/sc32f1xxx_dma.c" 2
# 27 "../hal/SC32F1X/src/sc32f1xxx_dma.c"
# 1 "../hal/SC32F1X/inc\\sc32f1xxx_dma.h" 1
# 35 "../hal/SC32F1X/inc\\sc32f1xxx_dma.h"
...
# 36 "../hal/SC32F1X/inc\\sc32f1xxx_dma.h" 2
# 1 "../hal/SC32F1X/inc\\sc32.h" 1
# 37 "../hal/SC32F1X/inc\\sc32f1xxx_dma.h" 2
...
# 38 "../hal/SC32F1X/inc\\sc32f1xxx_dma.h" 2
...
# 28 "../hal/SC32F1X/src/sc32f1xxx_dma.c" 2
# 58 "../hal/SC32F1X/src/sc32f1xxx_dma.c"
void DMA_DeInit(DMA_TypeDef * DMAx) {
...
# 85 "../hal/SC32F1X/src/sc32f1xxx_dma.c"
void DMA_Init(DMA_TypeDef * DMAx, DMA_InitTypeDef * DMA_InitStruct) {
    uint32_t tmpreg;
    ...
    tmpreg &= (uint32_t)~((0x3L << (0U)) | (0x3L << (2U)) | (0x1L << (4U)) | (0x1L << (6U)) |
                          (0x1L << (7U)) | (0x3L << (8U)) | (0x3L << (10U)) | (0x7L << (12U)) |
                          (0x1L << (15U)) | (0x3FL << (24U)));
...
# 158 "../hal/SC32F1X/src/sc32f1xxx_dma.c"
void DMA_Cmd(DMA_TypeDef * DMAx, FunctionalState NewState) {
    ...
    if (NewState != DISABLE) {
        ...
        DMAx->DMA_CFG |= (uint32_t)(0x1L << (7U));
    } else {

        DMAx->DMA_CFG &= ~(uint32_t)(0x1L << (7U));
    }
}
# 188 "../hal/SC32F1X/src/sc32f1xxx_dma.c"
void DMA_PauseCmd(DMA_TypeDef * DMAx, FunctionalState NewState) {
    ...
    if (NewState != DISABLE) {
        ...
        DMAx->DMA_CFG |= (uint32_t)(0x1L << (5U));
    } else {

        DMAx->DMA_CFG = (uint32_t)((DMAx->DMA_CFG | (0x1L << (7U))) & (~(0x1L << (5U))));
    }
}
# 218 "../hal/SC32F1X/src/sc32f1xxx_dma.c"
void DMA_CHRQCmd(DMA_TypeDef * DMAx, FunctionalState NewState) {
    ...
    if (NewState != DISABLE) {
        ...
        DMAx->DMA_CFG |= (uint32_t)(0x1L << (23U));
    } else {

        DMAx->DMA_CFG &= (uint32_t)~(0x1L << (23U));
    }
}
# 245 "../hal/SC32F1X/src/sc32f1xxx_dma.c"
void DMA_ChannelReset(DMA_TypeDef * DMAx) {

    ((void)0U);

    DMAx->DMA_CFG |= (uint32_t)(0x1L << (6U));
}
# 282 "../hal/SC32F1X/src/sc32f1xxx_dma.c"
void DMA_SetSrcAddress(DMA_TypeDef * DMAx, uint32_t SrcAddress) {
...
# 304 "../hal/SC32F1X/src/sc32f1xxx_dma.c"
void DMA_SetDstAddress(DMA_TypeDef * DMAx, uint32_t DstAddress) {
...
# 328 "../hal/SC32F1X/src/sc32f1xxx_dma.c"
void DMA_SetCurrDataCounter(DMA_TypeDef * DMAx, uint32_t Counter) {
...
# 349 "../hal/SC32F1X/src/sc32f1xxx_dma.c"
uint32_t DMA_GetCurrDataCounter(DMA_TypeDef * DMAx) {
...
# 370 "../hal/SC32F1X/src/sc32f1xxx_dma.c"
void DMA_SoftwareTrigger(DMA_TypeDef * DMAx) {

    ((void)0U);


    DMAx->DMA_STS = (0x1L << (8U));
}
# 415 "../hal/SC32F1X/src/sc32f1xxx_dma.c"
DMA_State_TypeDef DMA_GetStatus(DMA_TypeDef * DMAx) {
    ...
    Status = (DMA_State_TypeDef)(DMAx->DMA_STS & (0x0FL << (4U)));
    return Status;
}
# 446 "../hal/SC32F1X/src/sc32f1xxx_dma.c"
void DMA_ITConfig(DMA_TypeDef * DMAx, uint32_t DMA_IT, FunctionalState NewState) {
...
# 481 "../hal/SC32F1X/src/sc32f1xxx_dma.c"
FlagStatus DMA_GetFlagStatus(DMA_TypeDef * DMAx, DMA_Flag_TypeDef DMA_FLAG) {
...
# 519 "../hal/SC32F1X/src/sc32f1xxx_dma.c"
void DMA_ClearFlag(DMA_TypeDef * DMAx, uint32_t DMA_FLAG) {
...
# 546 "../hal/SC32F1X/src/sc32f1xxx_dma.c"
void DMA_DMACmd(DMA_TypeDef * DMAx, uint32_t DMA_DMARequest, FunctionalState NewState) {
