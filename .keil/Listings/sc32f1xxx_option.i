# 1 "../hal/SC32F1X/src/sc32f1xxx_option.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 392 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../hal/SC32F1X/src/sc32f1xxx_option.c" 2
# 27 "../hal/SC32F1X/src/sc32f1xxx_option.c"
# 1 "../hal/SC32F1X/inc\\sc32f1xxx_option.h" 1
# 35 "../hal/SC32F1X/inc\\sc32f1xxx_option.h"
...
# 36 "../hal/SC32F1X/inc\\sc32f1xxx_option.h" 2
# 1 "../hal/SC32F1X/inc\\sc32.h" 1
# 37 "../hal/SC32F1X/inc\\sc32f1xxx_option.h" 2
...
# 28 "../hal/SC32F1X/src/sc32f1xxx_option.c" 2
# 48 "../hal/SC32F1X/src/sc32f1xxx_option.c"
void OPTION_WDTCmd(FunctionalState NewState) {
    ((OPT_TypeDef *)(((0x40000000UL)) + (0x000003F8UL)))->OPINX = 0xC2;

    if (NewState == DISABLE) {
        ((OPT_TypeDef *)(((0x40000000UL)) + (0x000003F8UL)))->OPREG &= 0X7F;
    } else {
        ((OPT_TypeDef *)(((0x40000000UL)) + (0x000003F8UL)))->OPREG |= 0X80;
    }
}
# 68 "../hal/SC32F1X/src/sc32f1xxx_option.c"
void OPTION_LVRConfig(OPTION_LVR_TypeDef OPTION_LVR) {
    ((OPT_TypeDef *)(((0x40000000UL)) + (0x000003F8UL)))->OPINX = 0xC1;

    ((OPT_TypeDef *)(((0x40000000UL)) + (0x000003F8UL)))->OPREG &= 0XF8;

    ((OPT_TypeDef *)(((0x40000000UL)) + (0x000003F8UL)))->OPREG |= OPTION_LVR;
}
# 83 "../hal/SC32F1X/src/sc32f1xxx_option.c"
void OPTION_JTAGCmd(FunctionalState NewState) {
    ((OPT_TypeDef *)(((0x40000000UL)) + (0x000003F8UL)))->OPINX = 0xC2;
    if (NewState == DISABLE) {
        ((OPT_TypeDef *)(((0x40000000UL)) + (0x000003F8UL)))->OPREG |= 0X40;
    } else {
        ((OPT_TypeDef *)(((0x40000000UL)) + (0x000003F8UL)))->OPREG &= 0XBF;
    }
}
...
void OPTION_IAPPORA(uint16_t IAPPROAST, uint16_t IAPPROAED) {
    ((OPT_TypeDef *)(((0x40000000UL)) + (0x000003F8UL)))->OPINX = 0xC3;
    ((OPT_TypeDef *)(((0x40000000UL)) + (0x000003F8UL)))->OPREG = (IAPPROAST >> 8);
    ((OPT_TypeDef *)(((0x40000000UL)) + (0x000003F8UL)))->OPINX = 0xC4;
    ((OPT_TypeDef *)(((0x40000000UL)) + (0x000003F8UL)))->OPREG = (uint8_t)IAPPROAST;
    ((OPT_TypeDef *)(((0x40000000UL)) + (0x000003F8UL)))->OPINX = 0xC5;
    ((OPT_TypeDef *)(((0x40000000UL)) + (0x000003F8UL)))->OPREG = (IAPPROAED >> 8);
    ((OPT_TypeDef *)(((0x40000000UL)) + (0x000003F8UL)))->OPINX = 0xC6;
    ((OPT_TypeDef *)(((0x40000000UL)) + (0x000003F8UL)))->OPREG = (uint8_t)IAPPROAED;
}
...
void OPTION_IAPPORB(uint16_t IAPPROBST, uint16_t IAPPROBED) {
    ((OPT_TypeDef *)(((0x40000000UL)) + (0x000003F8UL)))->OPINX = 0xC7;
    ((OPT_TypeDef *)(((0x40000000UL)) + (0x000003F8UL)))->OPREG = (IAPPROBST >> 8);
    ((OPT_TypeDef *)(((0x40000000UL)) + (0x000003F8UL)))->OPINX = 0xC8;
    ((OPT_TypeDef *)(((0x40000000UL)) + (0x000003F8UL)))->OPREG = (uint8_t)IAPPROBST;
    ((OPT_TypeDef *)(((0x40000000UL)) + (0x000003F8UL)))->OPINX = 0xC9;
    ((OPT_TypeDef *)(((0x40000000UL)) + (0x000003F8UL)))->OPREG = (IAPPROBED >> 8);
    ((OPT_TypeDef *)(((0x40000000UL)) + (0x000003F8UL)))->OPINX = 0xCA;
    ((OPT_TypeDef *)(((0x40000000UL)) + (0x000003F8UL)))->OPREG = (uint8_t)(IAPPROBED);
}
