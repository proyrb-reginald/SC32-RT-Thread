# 1 "../hal/SC32F1X/src/sc32f1xxx_lcd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 392 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../hal/SC32F1X/src/sc32f1xxx_lcd.c" 2
# 28 "../hal/SC32F1X/src/sc32f1xxx_lcd.c"
# 1 "../hal/SC32F1X/inc\\sc32f1xxx_lcd.h" 1
# 35 "../hal/SC32F1X/inc\\sc32f1xxx_lcd.h"
...
# 36 "../hal/SC32F1X/inc\\sc32f1xxx_lcd.h" 2
# 1 "../hal/SC32F1X/inc\\sc32.h" 1
# 37 "../hal/SC32F1X/inc\\sc32f1xxx_lcd.h" 2
...
# 38 "../hal/SC32F1X/inc\\sc32f1xxx_lcd.h" 2
...
# 29 "../hal/SC32F1X/src/sc32f1xxx_lcd.c" 2
# 45 "../hal/SC32F1X/src/sc32f1xxx_lcd.c"
void LCD_DeInit(void) {
...
void LCD_Init(LCD_InitTypeDef * LCD_InitStruct) {
    ...
    tmpreg = ((LCD_LED_TypeDef *)(((0x40000000UL) + 0x22000) + (0x00000280UL)))->DDR_CFG;


    tmpreg &= (uint32_t)~((0x3L << (0U)) | (0x3L << (4U)) | (0x1L << (7U)));
    ...
    tmpreg |= (uint32_t)(LCD_InitStruct->LCD_ResSel | LCD_InitStruct->LCD_Duty |
                         (LCD_InitStruct->LCD_Voltage << (8U)));


    ((LCD_LED_TypeDef *)(((0x40000000UL) + 0x22000) + (0x00000280UL)))->DDR_CFG = tmpreg;





    ((LCD_LED_TypeDef *)(((0x40000000UL) + 0x22000) + (0x00000280UL)))->SEG_EN0 = (uint32_t)LCD_InitStruct->LCD_SegPin;
    ((LCD_LED_TypeDef *)(((0x40000000UL) + 0x22000) + (0x00000280UL)))->SEG_EN1 = (uint32_t)(LCD_InitStruct->LCD_SegPin >> 32);


    ((LCD_LED_TypeDef *)(((0x40000000UL) + 0x22000) + (0x00000280UL)))->COM_EN = LCD_InitStruct->LCD_ComPin;
}
...
# 135 "../hal/SC32F1X/src/sc32f1xxx_lcd.c"
void LCD_Cmd(FunctionalState NewState) {
...
# 172 "../hal/SC32F1X/src/sc32f1xxx_lcd.c"
void LCD_COMConfig(LCD_COMEN_Typedef COMSelect, FunctionalState NewState) {
    uint32_t temp;
...
# 221 "../hal/SC32F1X/src/sc32f1xxx_lcd.c"
void LCD_SEGConfig(uint64_t SEGSelect, FunctionalState NewState) {
# 232 "../hal/SC32F1X/src/sc32f1xxx_lcd.c"
    uint32_t temp0;
    uint32_t temp1;
...
# 291 "../hal/SC32F1X/src/sc32f1xxx_lcd.c"
void LCD_Write(LCD_RAMRegister_Typedef LCD_RAMRegister, uint8_t LCD_LED_Data) {
    ((LCD_LED_TypeDef *)(((0x40000000UL) + 0x22000) + (0x00000280UL)))->SEGRn[LCD_RAMRegister] = LCD_LED_Data;
}
