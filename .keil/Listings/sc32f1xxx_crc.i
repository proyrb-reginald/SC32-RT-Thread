# 1 "../hal/SC32F1X/src/sc32f1xxx_crc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 392 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../hal/SC32F1X/src/sc32f1xxx_crc.c" 2
# 27 "../hal/SC32F1X/src/sc32f1xxx_crc.c"
# 1 "../hal/SC32F1X/inc\\sc32f1xxx_crc.h" 1
# 35 "../hal/SC32F1X/inc\\sc32f1xxx_crc.h"
...
# 36 "../hal/SC32F1X/inc\\sc32f1xxx_crc.h" 2
# 1 "../hal/SC32F1X/inc\\sc32.h" 1
# 37 "../hal/SC32F1X/inc\\sc32f1xxx_crc.h" 2
...
# 38 "../hal/SC32F1X/inc\\sc32f1xxx_crc.h" 2
...
uint32_t CRC_Calculate(CRC_InputData_Format_TypeDef InputDataFormat,
                       uint32_t pBuffer[],
                       uint32_t BufferLength);
# 28 "../hal/SC32F1X/src/sc32f1xxx_crc.c" 2
...
# 47 "../hal/SC32F1X/src/sc32f1xxx_crc.c"
void CRC_DeInit(void) {
...
void CRC_Init(CRC_InitTypeDef * CRC_InitStruct) {
    ...
    if (CRC_InitStruct->DefaultPolynomialUse == DEFAULT_Polynomial_Enable) {
        ...
        ((CRC_TypeDef *)(((0x40000000UL)) + (0x00002000UL)))->CRC_POL = 0x04C11DB7U;

        ((CRC_TypeDef *)(((0x40000000UL)) + (0x00002000UL)))->CRC_CON &= (uint32_t)~(0x3L << (6U));
    } else {

        ((void)0U);


        ((CRC_TypeDef *)(((0x40000000UL)) + (0x00002000UL)))->CRC_POL = CRC_InitStruct->GeneratingPolynomial;

        ((CRC_TypeDef *)(((0x40000000UL)) + (0x00002000UL)))->CRC_CON &= (uint32_t)~(0x3L << (6U));


        ((CRC_TypeDef *)(((0x40000000UL)) + (0x00002000UL)))->CRC_CON |= (uint32_t)CRC_InitStruct->CRCSize;
    }
    ...
    if (CRC_InitStruct->DefaultInitValueUse == DEFAULT_InitValue_Enable) {
        ((CRC_TypeDef *)(((0x40000000UL)) + (0x00002000UL)))->CRC_INT = 0xFFFFFFFFU;
    } else {
        ((CRC_TypeDef *)(((0x40000000UL)) + (0x00002000UL)))->CRC_INT = CRC_InitStruct->InitValue;
    }
}
# 100 "../hal/SC32F1X/src/sc32f1xxx_crc.c"
void CRC_PolynomialSizeSelect(CRC_POLYSIZE_TypeDef CRC_PolSize) {

    ((void)0U);


    ((CRC_TypeDef *)(((0x40000000UL)) + (0x00002000UL)))->CRC_CON &= (uint32_t)~((uint32_t)(0x3L << (6U)));

    ((CRC_TypeDef *)(((0x40000000UL)) + (0x00002000UL)))->CRC_CON |= (uint32_t)CRC_PolSize;
}
...
void CRC_SetInitRegister(uint32_t CRC_InitValue) {
    ((CRC_TypeDef *)(((0x40000000UL)) + (0x00002000UL)))->CRC_INT = CRC_InitValue;
}
...
void CRC_SetPolynomial(uint32_t CRC_Pol) {
    ((CRC_TypeDef *)(((0x40000000UL)) + (0x00002000UL)))->CRC_POL = CRC_Pol;
}
# 144 "../hal/SC32F1X/src/sc32f1xxx_crc.c"
void CRC_ResetDR(void) {

    ((CRC_TypeDef *)(((0x40000000UL)) + (0x00002000UL)))->CRC_CON |= (0x1L << (0U));
}
# 157 "../hal/SC32F1X/src/sc32f1xxx_crc.c"
uint32_t CRC_CalcCRC(uint32_t CRC_Data) {

    ((CRC_TypeDef *)(((0x40000000UL)) + (0x00002000UL)))->CRC_DR = CRC_Data;

    return (((CRC_TypeDef *)(((0x40000000UL)) + (0x00002000UL)))->CRC_DR);
}
...
uint32_t CRC_CalcCRC16bits(uint16_t CRC_Data) {
    *(volatile uint16_t *)(&((CRC_TypeDef *)(((0x40000000UL)) + (0x00002000UL)))->CRC_DR) = (uint16_t)CRC_Data;
...
uint32_t CRC_CalcCRC8bits(uint8_t CRC_Data) {
    *(volatile uint8_t *)(&((CRC_TypeDef *)(((0x40000000UL)) + (0x00002000UL)))->CRC_DR) = (uint8_t)CRC_Data;
    return (((CRC_TypeDef *)(((0x40000000UL)) + (0x00002000UL)))->CRC_DR);
}
# 194 "../hal/SC32F1X/src/sc32f1xxx_crc.c"
uint32_t CRC_GetCRC(void) {
    return (((CRC_TypeDef *)(((0x40000000UL)) + (0x00002000UL)))->CRC_DR);
}
# 215 "../hal/SC32F1X/src/sc32f1xxx_crc.c"
uint32_t CRC_Accumulate(CRC_InputData_Format_TypeDef InputDataFormat,
                        uint32_t pBuffer[],
                        uint32_t BufferLength) {
    uint32_t index;
    ...
    switch (InputDataFormat) {
        case CRC_InputData_Format_WORDS:
            ...
            for (index = 0U; index < BufferLength; index++) {
                ((CRC_TypeDef *)(((0x40000000UL)) + (0x00002000UL)))->CRC_DR = pBuffer[index];
            }
            temp = ((CRC_TypeDef *)(((0x40000000UL)) + (0x00002000UL)))->CRC_DR;
            break;
...
# 257 "../hal/SC32F1X/src/sc32f1xxx_crc.c"
uint32_t CRC_Calculate(CRC_InputData_Format_TypeDef InputDataFormat,
                       uint32_t pBuffer[],
                       uint32_t BufferLength) {
    uint32_t index;
...
# 298 "../hal/SC32F1X/src/sc32f1xxx_crc.c"
static uint32_t CRC_Handle_8(uint8_t pBuffer[], uint32_t BufferLength) {
    uint32_t i;
    uint16_t data;
    ...
    for (i = 0U; i < (BufferLength / 4U); i++) {
        ((CRC_TypeDef *)(((0x40000000UL)) + (0x00002000UL)))->CRC_DR = ((uint32_t)pBuffer[4U * i] << 24U) |
    ...
    if ((BufferLength % 4U) != 0U) {
        if ((BufferLength % 4U) == 1U) {
            *(volatile uint8_t *)(volatile void *)(&((CRC_TypeDef *)(((0x40000000UL)) + (0x00002000UL)))->CRC_DR) =
                pBuffer[4U * i];
        }
        if ((BufferLength % 4U) == 2U) {
            data =
                (uint16_t)(((uint16_t)(pBuffer[4U * i]) << 8U) | (uint16_t)pBuffer[(4U * i) + 1U]);
            pReg = (volatile uint16_t *)(volatile void *)(&((CRC_TypeDef *)(((0x40000000UL)) + (0x00002000UL)))->CRC_DR);
            *pReg = data;
        }
...
# 345 "../hal/SC32F1X/src/sc32f1xxx_crc.c"
static uint32_t CRC_Handle_16(uint16_t pBuffer[], uint32_t BufferLength) {
    uint32_t i;
    volatile uint16_t * pReg;
    ...
    for (i = 0U; i < (BufferLength / 2U); i++) {
        ((CRC_TypeDef *)(((0x40000000UL)) + (0x00002000UL)))->CRC_DR = ((uint32_t)pBuffer[2U * i] << 16U) | (uint32_t)pBuffer[(2U * i) + 1U];
    }
