# 1 "../hal/SC32F1X/src/sc32f1xxx_twi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 392 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../hal/SC32F1X/src/sc32f1xxx_twi.c" 2
# 27 "../hal/SC32F1X/src/sc32f1xxx_twi.c"
# 1 "../hal/SC32F1X/inc\\sc32f1xxx_twi.h" 1
# 35 "../hal/SC32F1X/inc\\sc32f1xxx_twi.h"
...
# 36 "../hal/SC32F1X/inc\\sc32f1xxx_twi.h" 2
# 1 "../hal/SC32F1X/inc\\sc32.h" 1
# 37 "../hal/SC32F1X/inc\\sc32f1xxx_twi.h" 2
...
# 38 "../hal/SC32F1X/inc\\sc32f1xxx_twi.h" 2
...
# 28 "../hal/SC32F1X/src/sc32f1xxx_twi.c" 2
# 53 "../hal/SC32F1X/src/sc32f1xxx_twi.c"
void TWI_DeInit(TWI_TypeDef * TWIx) {
# 78 "../hal/SC32F1X/src/sc32f1xxx_twi.c"
    ((void)0U);
    if (TWIx == ((TWI_TypeDef *)(((0x40000000UL) + 0x20000) + (0x00000040UL)))) {

        RCC_APB0PeriphResetCmd(RCC_APB0Periph_QTWI0, ENABLE);

        RCC_APB0PeriphResetCmd(RCC_APB0Periph_QTWI0, DISABLE);
    } else if (TWIx == ((TWI_TypeDef *)(((0x40000000UL) + 0x21000) + (0x00000040UL)))) {
        RCC_APB1PeriphResetCmd(RCC_APB1Periph_QTWI1, ENABLE);

        RCC_APB1PeriphResetCmd(RCC_APB1Periph_QTWI1, DISABLE);

    } else if (TWIx == ((TWI_TypeDef *)(((0x40000000UL) + 0x20000) + (0x00000060UL)))) {

        RCC_APB0PeriphResetCmd(RCC_APB0Periph_QTWI2, ENABLE);

        RCC_APB0PeriphResetCmd(RCC_APB0Periph_QTWI2, DISABLE);

    } else if (TWIx == ((TWI_TypeDef *)(((0x40000000UL) + 0x21000) + (0x00000060UL)))) {
...
# 132 "../hal/SC32F1X/src/sc32f1xxx_twi.c"
void TWI_Init(TWI_TypeDef * TWIx, TWI_InitTypeDef * TWI_InitStruct) {
# 206 "../hal/SC32F1X/src/sc32f1xxx_twi.c"
    uint32_t tmpreg;
    ...
    tmpreg &= (uint32_t)~((0x1L << (1U)) | (0x3L << (13U)) | (0x1L << (0U)) |
                          (0x0FL << (8U)));
    ...
    tmpreg &= (uint32_t)~((0x1L << (0U)) | (0x7FL << (1U)));
...
# 262 "../hal/SC32F1X/src/sc32f1xxx_twi.c"
void TWI_Cmd(TWI_TypeDef * TWIx, FunctionalState NewState) {
# 277 "../hal/SC32F1X/src/sc32f1xxx_twi.c"
    ((void)0U);
    ((void)0U);
    if (NewState != DISABLE) {

        TWIx->TWI_CON |= (0x1L << (7U));
    } else {

        TWIx->TWI_CON &= (uint16_t)~(0x1L << (7U));
    }

}
# 305 "../hal/SC32F1X/src/sc32f1xxx_twi.c"
void TWI_AcknowledgeConfig(TWI_TypeDef * TWIx, FunctionalState NewState) {
# 320 "../hal/SC32F1X/src/sc32f1xxx_twi.c"
    ((void)0U);
    ((void)0U);
    if (NewState != DISABLE) {

        TWIx->TWI_CON |= (0x1L << (1U));
    } else {

        TWIx->TWI_CON &= (uint16_t)~(0x1L << (1U));
    }

}
# 348 "../hal/SC32F1X/src/sc32f1xxx_twi.c"
void TWI_GeneralCallCmd(TWI_TypeDef * TWIx, FunctionalState NewState) {
# 363 "../hal/SC32F1X/src/sc32f1xxx_twi.c"
    ((void)0U);
    ((void)0U);
    if (NewState != DISABLE) {

        TWIx->TWI_ADD |= (0x1L << (0U));
    } else {

        TWIx->TWI_ADD &= (uint16_t)~(0x1L << (0U));
    }

}
# 391 "../hal/SC32F1X/src/sc32f1xxx_twi.c"
void TWI_StretchClockConfig(TWI_TypeDef * TWIx, FunctionalState NewState) {
# 406 "../hal/SC32F1X/src/sc32f1xxx_twi.c"
    ((void)0U);
    ((void)0U);
    if (NewState == DISABLE) {

        TWIx->TWI_CON |= (0x1L << (0U));
    } else {

        TWIx->TWI_CON &= (uint16_t)~((uint16_t)(0x1L << (0U)));
    }

}
# 433 "../hal/SC32F1X/src/sc32f1xxx_twi.c"
void TWI_SetNbytes(TWI_TypeDef * TWIx, uint8_t Nbytes) {
# 442 "../hal/SC32F1X/src/sc32f1xxx_twi.c"
    ((void)0U);

    TWIx->TWI_STS = (uint32_t)(Nbytes << (16U));

}
# 461 "../hal/SC32F1X/src/sc32f1xxx_twi.c"
uint8_t TWI_GetNbytes(TWI_TypeDef * TWIx) {
# 473 "../hal/SC32F1X/src/sc32f1xxx_twi.c"
    uint8_t tmpnum;


    ((void)0U);

    tmpnum = (uint8_t)(TWIx->TWI_STS >> (16U));

    return tmpnum;

}
# 511 "../hal/SC32F1X/src/sc32f1xxx_twi.c"
void TWI_GenerateSTART(TWI_TypeDef * TWIx, FunctionalState NewState) {
# 526 "../hal/SC32F1X/src/sc32f1xxx_twi.c"
    ((void)0U);
    ((void)0U);
    if (NewState != DISABLE) {

        TWIx->TWI_CON |= (0x1L << (5U));
    } else {

        TWIx->TWI_CON &= (uint16_t)~(0x1L << (5U));
    }

}
# 554 "../hal/SC32F1X/src/sc32f1xxx_twi.c"
void TWI_GenerateSTOP(TWI_TypeDef * TWIx, FunctionalState NewState) {
# 569 "../hal/SC32F1X/src/sc32f1xxx_twi.c"
    ((void)0U);
    ((void)0U);
    if (NewState != DISABLE) {

        TWIx->TWI_CON |= (0x1L << (4U));
    } else {

        TWIx->TWI_CON &= (uint16_t)~(0x1L << (4U));
    }

}
# 598 "../hal/SC32F1X/src/sc32f1xxx_twi.c"
void TWI_Send7bitAddress(TWI_TypeDef * TWIx, uint8_t Address, TWI_Command_TypeDef TWI_Command) {
...
# 634 "../hal/SC32F1X/src/sc32f1xxx_twi.c"
void TWI_SendData(TWI_TypeDef * TWIx, uint8_t Data) {
...
# 654 "../hal/SC32F1X/src/sc32f1xxx_twi.c"
uint8_t TWI_ReceiveData(TWI_TypeDef * TWIx) {
...
# 689 "../hal/SC32F1X/src/sc32f1xxx_twi.c"
void TWI_PinRemapConfig(TWI_TypeDef * TWIx, TWI_PinRemap_TypeDef TWI_Remap) {
# 720 "../hal/SC32F1X/src/sc32f1xxx_twi.c"
    uint32_t tmpreg;
...
# 768 "../hal/SC32F1X/src/sc32f1xxx_twi.c"
void TWI_ITConfig(TWI_TypeDef * TWIx, uint16_t TWI_IT, FunctionalState NewState) {
...
# 808 "../hal/SC32F1X/src/sc32f1xxx_twi.c"
FlagStatus TWI_GetFlagStatus(TWI_TypeDef * TWIx, TWI_FLAG_TypeDef TWI_FLAG) {
...
# 839 "../hal/SC32F1X/src/sc32f1xxx_twi.c"
void TWI_ClearFlag(TWI_TypeDef * TWIx, TWI_FLAG_TypeDef TWI_FLAG) {
...
# 871 "../hal/SC32F1X/src/sc32f1xxx_twi.c"
TWI_StateMachine_TypeDef TWI_GetStateMachine(TWI_TypeDef * TWIx) {
# 880 "../hal/SC32F1X/src/sc32f1xxx_twi.c"
    ((void)0U);

    return (TWI_StateMachine_TypeDef)(TWIx->TWI_STS & (0x7L << (8U)));

}
# 905 "../hal/SC32F1X/src/sc32f1xxx_twi.c"
void TWI_DMACmd(TWI_TypeDef * TWIx, TWI_DMAReq_TypeDef TWI_DMAReq, FunctionalState NewState) {
