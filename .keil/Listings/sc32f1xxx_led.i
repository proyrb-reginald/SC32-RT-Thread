# 1 "../hal/SC32F1X/src/sc32f1xxx_led.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 392 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../hal/SC32F1X/src/sc32f1xxx_led.c" 2
# 28 "../hal/SC32F1X/src/sc32f1xxx_led.c"
# 1 "../hal/SC32F1X/inc\\sc32f1xxx_led.h" 1
# 35 "../hal/SC32F1X/inc\\sc32f1xxx_led.h"
...
# 36 "../hal/SC32F1X/inc\\sc32f1xxx_led.h" 2
# 1 "../hal/SC32F1X/inc\\sc32.h" 1
# 37 "../hal/SC32F1X/inc\\sc32f1xxx_led.h" 2
...
# 38 "../hal/SC32F1X/inc\\sc32f1xxx_led.h" 2
...
# 29 "../hal/SC32F1X/src/sc32f1xxx_led.c" 2
# 45 "../hal/SC32F1X/src/sc32f1xxx_led.c"
void LED_DeInit(void) {
...
void LED_Init(LED_InitTypeDef * LED_InitStruct) {
    ...
    tmpreg = ((LCD_LED_TypeDef *)(((0x40000000UL) + 0x22000) + (0x00000280UL)))->DDR_CON;


    tmpreg &= (uint32_t)~((0x1L << (0U)) | (0x1L << (4U)) | (0x3L << (8U)) | (0x1L << (15U)));




    tmpreg |= (uint32_t)((0x1L << (0U)) | LED_InitStruct->LED_FrameFre);

    ((LCD_LED_TypeDef *)(((0x40000000UL) + 0x22000) + (0x00000280UL)))->DDR_CON = tmpreg;



    ((LCD_LED_TypeDef *)(((0x40000000UL) + 0x22000) + (0x00000280UL)))->DDR_CFG &= (uint32_t)~((0x3L << (4U)) | (0x1L << (7U)));




    ((LCD_LED_TypeDef *)(((0x40000000UL) + 0x22000) + (0x00000280UL)))->DDR_CFG |= (uint32_t)LED_InitStruct->LED_Duty;





    ((LCD_LED_TypeDef *)(((0x40000000UL) + 0x22000) + (0x00000280UL)))->SEG_EN0 = (uint32_t)LED_InitStruct->LED_SegPin;
    ((LCD_LED_TypeDef *)(((0x40000000UL) + 0x22000) + (0x00000280UL)))->SEG_EN1 = (uint32_t)(LED_InitStruct->LED_SegPin >> 32);



    ((LCD_LED_TypeDef *)(((0x40000000UL) + 0x22000) + (0x00000280UL)))->COM_EN = LED_InitStruct->LED_ComPin;
}
...
# 120 "../hal/SC32F1X/src/sc32f1xxx_led.c"
void LED_Cmd(FunctionalState NewState) {
    ...
    if (NewState != DISABLE) {
        ...
        ((LCD_LED_TypeDef *)(((0x40000000UL) + 0x22000) + (0x00000280UL)))->DDR_CON |= (0x1L << (7U));
    } else {

        ((LCD_LED_TypeDef *)(((0x40000000UL) + 0x22000) + (0x00000280UL)))->DDR_CON &= (uint16_t)~(0x1L << (7U));
    }
}
# 192 "../hal/SC32F1X/src/sc32f1xxx_led.c"
void LED_Write(LED_RAMRegister_Typedef LED_RAMRegister, uint8_t LED_Data) {
    ((LCD_LED_TypeDef *)(((0x40000000UL) + 0x22000) + (0x00000280UL)))->SEGRn[LED_RAMRegister] = LED_Data;
}
# 204 "../hal/SC32F1X/src/sc32f1xxx_led.c"
void LED_COMConfig(LED_COMEN_Typedef COMSelect, FunctionalState NewState) {
    uint32_t temp;
    temp = ((LCD_LED_TypeDef *)(((0x40000000UL) + 0x22000) + (0x00000280UL)))->COM_EN;
    if (NewState != DISABLE) {
        temp |= COMSelect;
    } else {
        temp &= ~COMSelect;
    }
    ((LCD_LED_TypeDef *)(((0x40000000UL) + 0x22000) + (0x00000280UL)))->COM_EN = temp;
}
# 260 "../hal/SC32F1X/src/sc32f1xxx_led.c"
void LED_SEGConfig(uint64_t SEGSelect, FunctionalState NewState) {
# 271 "../hal/SC32F1X/src/sc32f1xxx_led.c"
    uint32_t temp0;
    uint32_t temp1;
    temp0 = ((LCD_LED_TypeDef *)(((0x40000000UL) + 0x22000) + (0x00000280UL)))->SEG_EN0;
    temp1 = ((LCD_LED_TypeDef *)(((0x40000000UL) + 0x22000) + (0x00000280UL)))->SEG_EN1;
    if (NewState == ENABLE) {
        temp0 |= SEGSelect;
        temp1 |= SEGSelect >> 32;
    } else {
    ...
    ((LCD_LED_TypeDef *)(((0x40000000UL) + 0x22000) + (0x00000280UL)))->SEG_EN0 = (uint32_t)temp0;
    ((LCD_LED_TypeDef *)(((0x40000000UL) + 0x22000) + (0x00000280UL)))->SEG_EN1 = (uint32_t)temp1;
...
void LED_CustomModeScan(void) {
    ((LCD_LED_TypeDef *)(((0x40000000UL) + 0x22000) + (0x00000280UL)))->DDR_CON = (0x1L << (14U));
}
