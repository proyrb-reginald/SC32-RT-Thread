# 1 "../hal/SC32F1X/src/sc32f1xxx_spi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 392 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../hal/SC32F1X/src/sc32f1xxx_spi.c" 2
# 27 "../hal/SC32F1X/src/sc32f1xxx_spi.c"
# 1 "../hal/SC32F1X/inc\\sc32f1xxx_spi.h" 1
# 35 "../hal/SC32F1X/inc\\sc32f1xxx_spi.h"
...
# 36 "../hal/SC32F1X/inc\\sc32f1xxx_spi.h" 2
# 1 "../hal/SC32F1X/inc\\sc32.h" 1
# 37 "../hal/SC32F1X/inc\\sc32f1xxx_spi.h" 2
...
# 38 "../hal/SC32F1X/inc\\sc32f1xxx_spi.h" 2
...
# 28 "../hal/SC32F1X/src/sc32f1xxx_spi.c" 2
# 53 "../hal/SC32F1X/src/sc32f1xxx_spi.c"
void SPI_DeInit(SPI_TypeDef * SPIx) {

    ((void)0U);
    if (SPIx == ((SPI_TypeDef *)(((0x40000000UL) + 0x20000) + (0x00000040UL)))) {
    ...
    } else if (SPIx == ((SPI_TypeDef *)(((0x40000000UL) + 0x21000) + (0x00000040UL)))) {
...
# 95 "../hal/SC32F1X/src/sc32f1xxx_spi.c"
    if (SPIx == ((SPI_TypeDef *)(((0x40000000UL) + 0x20000) + (0x00000060UL)))) {

        RCC_APB0PeriphResetCmd(RCC_APB0Periph_QTWI2, ENABLE);

        RCC_APB0PeriphResetCmd(RCC_APB0Periph_QTWI2, DISABLE);
    } else if (SPIx == ((SPI_TypeDef *)(((0x40000000UL) + 0x21000) + (0x00000060UL)))) {
...
# 137 "../hal/SC32F1X/src/sc32f1xxx_spi.c"
void SPI_Init(SPI_TypeDef * SPIx, SPI_InitTypeDef * SPI_InitStruct) {
# 221 "../hal/SC32F1X/src/sc32f1xxx_spi.c"
    uint32_t tmpreg;
    ...
    tmpreg &= (uint32_t)~((0x1L << (16U)) | (0x3L << (28U)) | (0x1L << (18U)) | (0x1L << (19U)) |
                          (0x1L << (20U)) | (0x0FL << (8U)) | (0x3L << (22U)));
    ...
    tmpreg |= (uint32_t)(SPI_InitStruct->SPI_Mode | SPI_InitStruct->SPI_DataSize | SPI_InitStruct->SPI_FirstBit |
                         SPI_InitStruct->SPI_CPHA | SPI_InitStruct->SPI_CPOL) |
              (0x01 << (22U)) | SPI_InitStruct->SPI_Prescaler;
...
# 271 "../hal/SC32F1X/src/sc32f1xxx_spi.c"
void SPI_Cmd(SPI_TypeDef * SPIx, FunctionalState NewState) {
# 307 "../hal/SC32F1X/src/sc32f1xxx_spi.c"
    ((void)0U);
    ((void)0U);

    if (NewState != DISABLE) {

        SPIx->SPI_CON |= (0x1L << (7U));
    } else {

        SPIx->SPI_CON &= (uint16_t)~(0x1L << (7U));
    }

}
# 336 "../hal/SC32F1X/src/sc32f1xxx_spi.c"
void SPI_SetMode(SPI_TypeDef * SPIx, SPI_Mode_TypeDef SPI_Mode) {
# 368 "../hal/SC32F1X/src/sc32f1xxx_spi.c"
    uint32_t tmpreg;
...
# 406 "../hal/SC32F1X/src/sc32f1xxx_spi.c"
void SPI_DataSizeConfig(SPI_TypeDef * SPIx, SPI_DataSize_TypeDef SPI_DataSize) {
# 434 "../hal/SC32F1X/src/sc32f1xxx_spi.c"
    ((void)0U);
    ((void)0U);


    SPIx->SPI_CON &= (uint16_t)~(0x3L << (28U));

    SPIx->SPI_CON |= SPI_DataSize;

}
# 475 "../hal/SC32F1X/src/sc32f1xxx_spi.c"
void SPI_SendDataFIFO(SPI_TypeDef * SPIx, uint32_t * Data, uint16_t length) {
# 512 "../hal/SC32F1X/src/sc32f1xxx_spi.c"
    uint8_t tmpNum;

    ((void)0U);

    if ((SPIx == ((SPI_TypeDef *)(((0x40000000UL) + 0x20000) + (0x00000040UL)))) || (SPIx == ((SPI_TypeDef *)(((0x40000000UL) + 0x21000) + (0x00000040UL))))) {
        if ((SPIx->SPI_CON & (0x3L << (28U))) >= SPI_DataSize_24B) {
            for (tmpNum = 0; tmpNum < length; tmpNum++) {
                SPIx->SPI_DATA = (uint32_t)(*((uint32_t *)Data + tmpNum));
            }
        } else if ((SPIx->SPI_CON & (0x3L << (28U))) == SPI_DataSize_16B) {
            for (tmpNum = 0; tmpNum < length; tmpNum++) {
                SPIx->SPI_DATA = (uint32_t)(*((uint16_t *)Data + tmpNum));
            }
        }

        else if ((SPIx->SPI_CON & (0x3L << (28U))) == SPI_DataSize_8B) {
            for (tmpNum = 0; tmpNum < length; tmpNum++) {
...
# 551 "../hal/SC32F1X/src/sc32f1xxx_spi.c"
void SPI_ReceiveDataFIFO(SPI_TypeDef * SPIx, uint32_t * Data, uint16_t length) {
# 587 "../hal/SC32F1X/src/sc32f1xxx_spi.c"
    uint16_t tmpNum;
...
# 626 "../hal/SC32F1X/src/sc32f1xxx_spi.c"
void SPI_SendData(SPI_TypeDef * SPIx, uint32_t Data) {
...
# 646 "../hal/SC32F1X/src/sc32f1xxx_spi.c"
uint32_t SPI_ReceiveData(SPI_TypeDef * SPIx) {

    ((void)0U);
    return (uint32_t)SPIx->SPI_DATA;
}
# 689 "../hal/SC32F1X/src/sc32f1xxx_spi.c"
void SPI_PinRemapConfig(SPI_TypeDef * SPIx, SPI_PinRemap_TypeDef SPI_PinRemap) {
# 726 "../hal/SC32F1X/src/sc32f1xxx_spi.c"
    uint32_t tmpreg;
    ...
    if ((SPIx == ((SPI_TypeDef *)(((0x40000000UL) + 0x20000) + (0x00000060UL)))) || (SPIx == ((SPI_TypeDef *)(((0x40000000UL) + 0x21000) + (0x00000060UL))))) {
...
# 781 "../hal/SC32F1X/src/sc32f1xxx_spi.c"
void SPI_ITConfig(SPI_TypeDef * SPIx, uint16_t SPI_IT, FunctionalState NewState) {
...
# 819 "../hal/SC32F1X/src/sc32f1xxx_spi.c"
FlagStatus SPI_GetFlagStatus(SPI_TypeDef * SPIx, SPI_FLAG_TypeDef SPI_FLAG) {
    ...
    return bitstatus;
# 860 "../hal/SC32F1X/src/sc32f1xxx_spi.c"
}
# 883 "../hal/SC32F1X/src/sc32f1xxx_spi.c"
void SPI_ClearFlag(SPI_TypeDef * SPIx, SPI_FLAG_TypeDef SPI_FLAG) {
...
# 904 "../hal/SC32F1X/src/sc32f1xxx_spi.c"
}
# 925 "../hal/SC32F1X/src/sc32f1xxx_spi.c"
void SPI_DMACmd(SPI_TypeDef * SPIx, SPI_DMAReq_TypeDef SPI_DMAReq, FunctionalState NewState) {
