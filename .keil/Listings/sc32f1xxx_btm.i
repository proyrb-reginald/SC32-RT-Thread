# 1 "../hal/SC32F1X/src/sc32f1xxx_btm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 392 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../hal/SC32F1X/src/sc32f1xxx_btm.c" 2
# 27 "../hal/SC32F1X/src/sc32f1xxx_btm.c"
# 1 "../hal/SC32F1X/inc\\sc32f1xxx_btm.h" 1
# 35 "../hal/SC32F1X/inc\\sc32f1xxx_btm.h"
...
# 36 "../hal/SC32F1X/inc\\sc32f1xxx_btm.h" 2
# 1 "../hal/SC32F1X/inc\\sc32.h" 1
# 37 "../hal/SC32F1X/inc\\sc32f1xxx_btm.h" 2
...
# 38 "../hal/SC32F1X/inc\\sc32f1xxx_btm.h" 2
...
# 28 "../hal/SC32F1X/src/sc32f1xxx_btm.c" 2
# 46 "../hal/SC32F1X/src/sc32f1xxx_btm.c"
void BTM_DeInit(BTM_TypeDef * BTMx) {

    ((void)0U);

    if (BTMx == ((BTM_TypeDef *)(((0x40000000UL) + 0x22000) + (0x00000100UL)))) {

        BTMx->BTM_CON = 0x0000;
        BTMx->BTM_STS = 0xFFFF;
    }
}
# 76 "../hal/SC32F1X/src/sc32f1xxx_btm.c"
void BTM_FSConfig(BTM_TypeDef * BTMx, BTM_FreqSelect_TypeDef BTM_FreqSelect) {
    uint32_t tmpreg;
...
# 104 "../hal/SC32F1X/src/sc32f1xxx_btm.c"
void BTM_Cmd(BTM_TypeDef * BTMx, FunctionalState NewState) {
    ...
    if (NewState != DISABLE) {
        ...
        BTMx->BTM_CON |= (0x1L << (7U));
    } else {

        BTMx->BTM_CON &= (uint16_t)~(0x1L << (7U));
    }
}
# 140 "../hal/SC32F1X/src/sc32f1xxx_btm.c"
void BTM_ITConfig(BTM_TypeDef * BTMx, uint16_t BTM_IT, FunctionalState NewState) {
...
# 165 "../hal/SC32F1X/src/sc32f1xxx_btm.c"
FlagStatus BTM_GetFlagStatus(BTM_TypeDef * BTMx, BTM_FLAG_TypeDef BTM_FLAG) {
...
# 187 "../hal/SC32F1X/src/sc32f1xxx_btm.c"
void BTM_ClearFlag(BTM_TypeDef * BTMx, BTM_FLAG_TypeDef BTM_FLAG) {
