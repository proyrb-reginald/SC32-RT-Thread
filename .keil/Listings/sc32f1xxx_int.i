# 1 "../hal/SC32F1X/src/sc32f1xxx_int.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 392 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../hal/SC32F1X/src/sc32f1xxx_int.c" 2
# 27 "../hal/SC32F1X/src/sc32f1xxx_int.c"
# 1 "../hal/SC32F1X/inc\\sc32f1xxx_int.h" 1
# 35 "../hal/SC32F1X/inc\\sc32f1xxx_int.h"
...
# 36 "../hal/SC32F1X/inc\\sc32f1xxx_int.h" 2
# 1 "../hal/SC32F1X/inc\\sc32.h" 1
# 37 "../hal/SC32F1X/inc\\sc32f1xxx_int.h" 2
...
# 38 "../hal/SC32F1X/inc\\sc32f1xxx_int.h" 2
...
# 28 "../hal/SC32F1X/src/sc32f1xxx_int.c" 2
# 44 "../hal/SC32F1X/src/sc32f1xxx_int.c"
void INT_DeInit(void) {
    ((INT_TypeDef *)(((0x40000000UL) + 0x11000) + (0x00000800UL)))->INTF_IE = (uint16_t)0x00000000U;
    ((INT_TypeDef *)(((0x40000000UL) + 0x11000) + (0x00000800UL)))->INTR_IE = (uint16_t)0x00000000U;
    ((INT_TypeDef *)(((0x40000000UL) + 0x11000) + (0x00000800UL)))->INT_SEL0 = (uint16_t)0x00000000U;
    ((INT_TypeDef *)(((0x40000000UL) + 0x11000) + (0x00000800UL)))->INT_SEL1 = (uint16_t)0x00000000U;
    ((INT_TypeDef *)(((0x40000000UL) + 0x11000) + (0x00000800UL)))->INTF_CON = (uint16_t)0x00000000U;
    ((INT_TypeDef *)(((0x40000000UL) + 0x11000) + (0x00000800UL)))->INTR_CON = (uint16_t)0x00000000U;
    ((INT_TypeDef *)(((0x40000000UL) + 0x11000) + (0x00000800UL)))->INTF_STS = (uint16_t)0x00000000U;
    ((INT_TypeDef *)(((0x40000000UL) + 0x11000) + (0x00000800UL)))->INTR_STS = (uint16_t)0x00000000U;
}
...
void INT_Init(INT_InitTypeDef * INT_InitStruct) {
    ...
    if ((INT_InitStruct->INT_Trigger & INT_Trigger_Rising) != INT_Trigger_Null) {
        ...
        ((INT_TypeDef *)(((0x40000000UL) + 0x11000) + (0x00000800UL)))->INTR_CON |= (uint32_t)INT_InitStruct->INT_Channel;
    } else {
    ...
    if ((INT_InitStruct->INT_Trigger & INT_Trigger_Falling) != INT_Trigger_Null) {
        ...
        ((INT_TypeDef *)(((0x40000000UL) + 0x11000) + (0x00000800UL)))->INTF_CON |= (uint32_t)INT_InitStruct->INT_Channel;
    } else {
    ...
    tmpreg = ((INT_TypeDef *)(((0x40000000UL) + 0x11000) + (0x00000800UL)))->INT_SEL0;
    ...
    ((INT_TypeDef *)(((0x40000000UL) + 0x11000) + (0x00000800UL)))->INT_SEL0 = tmpreg;


    tmpreg = ((INT_TypeDef *)(((0x40000000UL) + 0x11000) + (0x00000800UL)))->INT_SEL1;
    ...
    ((INT_TypeDef *)(((0x40000000UL) + 0x11000) + (0x00000800UL)))->INT_SEL1 = tmpreg;
}
# 141 "../hal/SC32F1X/src/sc32f1xxx_int.c"
void INT_TriggerMode(INT_Channel_Typedef INT_Channel, INT_Trigger_TypeDef Trigger_Mode) {
    if ((Trigger_Mode & INT_Trigger_Rising) != INT_Trigger_Null) {

        ((INT_TypeDef *)(((0x40000000UL) + 0x11000) + (0x00000800UL)))->INTR_CON |= (uint32_t)INT_Channel;
    } else {
    ...
    if ((Trigger_Mode & INT_Trigger_Falling) != INT_Trigger_Null) {
        ...
        ((INT_TypeDef *)(((0x40000000UL) + 0x11000) + (0x00000800UL)))->INTF_CON |= (uint32_t)INT_Channel;
    } else {

        ((INT_TypeDef *)(((0x40000000UL) + 0x11000) + (0x00000800UL)))->INTF_CON &= (uint32_t)(~INT_Channel);
    }
}
# 203 "../hal/SC32F1X/src/sc32f1xxx_int.c"
void INT_ITConfig(uint16_t INT_Channel, uint16_t INT_IT, FunctionalState NewState) {
    ...
    if (INT_IT & INT_Trigger_Rising) {
        if (NewState == ENABLE) {
            ((INT_TypeDef *)(((0x40000000UL) + 0x11000) + (0x00000800UL)))->INTR_IE |= INT_Channel;
        } else {
            ((INT_TypeDef *)(((0x40000000UL) + 0x11000) + (0x00000800UL)))->INTR_IE &= (uint16_t)(~INT_Channel);
        }
    }
    ...
    if (INT_IT & INT_Trigger_Falling) {
        if (NewState == ENABLE) {
            ((INT_TypeDef *)(((0x40000000UL) + 0x11000) + (0x00000800UL)))->INTF_IE |= INT_Channel;
        } else {
            ((INT_TypeDef *)(((0x40000000UL) + 0x11000) + (0x00000800UL)))->INTF_IE &= (uint16_t)(~INT_Channel);
        }
    }
}
# 254 "../hal/SC32F1X/src/sc32f1xxx_int.c"
FlagStatus INT_GetFlagStatus(INT_Channel_Typedef INT_Channel, INT_Flag_TypeDef INT_Flag) {
    ...
    if (INT_Flag & INT_Flag_Rising) {
        if ((((INT_TypeDef *)(((0x40000000UL) + 0x11000) + (0x00000800UL)))->INTR_STS & INT_Channel) != (uint16_t)RESET) {
            bitstatus = SET;
        } else {
            bitstatus = RESET;
        }
    } else {
        if ((((INT_TypeDef *)(((0x40000000UL) + 0x11000) + (0x00000800UL)))->INTF_STS & INT_Channel) != (uint16_t)RESET) {
            bitstatus = SET;
        } else {
            bitstatus = RESET;
        }
...
# 301 "../hal/SC32F1X/src/sc32f1xxx_int.c"
void INT_ClearFlag(uint32_t INT_Channel) {

    ((void)0U);


    ((INT_TypeDef *)(((0x40000000UL) + 0x11000) + (0x00000800UL)))->INTR_STS &= (uint16_t)(~INT_Channel);
    ((INT_TypeDef *)(((0x40000000UL) + 0x11000) + (0x00000800UL)))->INTF_STS &= (uint16_t)(~INT_Channel);
}
