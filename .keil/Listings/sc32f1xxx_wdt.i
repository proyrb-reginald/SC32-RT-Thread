# 1 "../hal/SC32F1X/src/sc32f1xxx_wdt.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 392 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../hal/SC32F1X/src/sc32f1xxx_wdt.c" 2
# 27 "../hal/SC32F1X/src/sc32f1xxx_wdt.c"
# 1 "../hal/SC32F1X/inc\\sc32f1xxx_wdt.h" 1
# 35 "../hal/SC32F1X/inc\\sc32f1xxx_wdt.h"
...
# 36 "../hal/SC32F1X/inc\\sc32f1xxx_wdt.h" 2
# 1 "../hal/SC32F1X/inc\\sc32.h" 1
# 37 "../hal/SC32F1X/inc\\sc32f1xxx_wdt.h" 2
...
# 38 "../hal/SC32F1X/inc\\sc32f1xxx_wdt.h" 2
...
# 28 "../hal/SC32F1X/src/sc32f1xxx_wdt.c" 2
# 45 "../hal/SC32F1X/src/sc32f1xxx_wdt.c"
void WDT_DeInit(void) {


    ((WDT_TypeDef *)(((0x40000000UL)) + (0x00000330UL)))->WDT_CFG = 0x00;
    ((WDT_TypeDef *)(((0x40000000UL)) + (0x00000330UL)))->WDT_CON = 0x00;
}
# 65 "../hal/SC32F1X/src/sc32f1xxx_wdt.c"
void WDT_SetOverTime(WDT_OverTime_TypeDef WDT_OverTime) {
    uint8_t tmpreg;

    ((void)0U);

    tmpreg = (uint8_t)((WDT_TypeDef *)(((0x40000000UL)) + (0x00000330UL)))->WDT_CFG;

    tmpreg &= ~(0x7L << (0U));

    tmpreg |= WDT_OverTime;

    ((WDT_TypeDef *)(((0x40000000UL)) + (0x00000330UL)))->WDT_CFG = tmpreg;
}
# 87 "../hal/SC32F1X/src/sc32f1xxx_wdt.c"
void WDT_Cmd(FunctionalState NewState) {
...
# 111 "../hal/SC32F1X/src/sc32f1xxx_wdt.c"
void WDT_SetReload(void) {

    ((WDT_TypeDef *)(((0x40000000UL)) + (0x00000330UL)))->WDT_CON |= (0x1L << (0U));
}
