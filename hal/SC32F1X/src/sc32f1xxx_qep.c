...
void QEP_Init(QEP_TypeDef * QEPx, QEP_InitTypeDef * QEP_InitStruct) {
    ...
    tmpreg = QEPx->QEP_CON;
    tmpreg &= ~(QEP_CON_QSRC | QEP_CON_RPCEN | QEP_CON_FPCEN | QEP_CON_QIP | QEP_CON_QAGATE |
                QEP_CON_QBGATE | QEP_CON_IGATE | QEP_CON_QFDIV | QEP_CON_QAP | QEP_CON_QBP |
                QEP_CON_PCRM | QEP_CON_SWAP);
    ...
    tmpreg |=
        (QEP_InitStruct->QEP_QAP << QEP_CON_QAP_Pos) | (QEP_InitStruct->QEP_QBP << QEP_CON_QBP_Pos);
