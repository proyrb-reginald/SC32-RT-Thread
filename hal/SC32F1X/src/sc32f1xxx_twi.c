 ...
 * TWI_PinRemap_C TWI1:TWI_PinRemap_Default,TWI_PinRemap_A - TWI_PinRemap_B) SC32f12xx Selection
 * range(TWI_PinRemap_Default,TWI_PinRemap_A - TWI_PinRemap_E) SC32f15xx Selection
