 ...
 *               -OP_TriggerMode_RISE_FALL:The trigger mode of the simulated comparator is rising
 ...
 *               - OP_CMPSTA_Low: The non-inverting input is at a lower voltage than the inverting
 * input
 *               - OP_CMPSTA_High: The non-inverting input is at a higher voltage than the inverting
 * input
 */
