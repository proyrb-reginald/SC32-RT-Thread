 ...
 * ADC_Channel_VDD_D4) SC32R803 Selection range(ADC_Channel_0 - ADC_Channel_17    ADC_Channel_VDD_D4
 * ADC_Channel_OP) SC32f12xx Selection range(ADC_Channel_0 - ADC_Channel_15    ADC_Channel_VDD_D4
 * ADC_Channel_OP) SC32f15xx Selection range(ADC_Channel_0 - ADC_Channel_15    ADC_Channel_VDD_D4
 * ADC_Channel_TEMP)
