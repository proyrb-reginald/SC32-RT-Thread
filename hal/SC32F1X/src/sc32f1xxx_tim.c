...
@endverbatim
  ...
  */
/**
 * @brief  Initializes the input capture mode for TIMx according to the parameters specified in
 *TIM_IC_InitStruct.
 * @param  TIMx[out]: where x can be to select the TIMx peripheral.
 *					SC32f10xx Selection range(TIM0 - TIM7)
 *          SC32R803 Selection range(TIM0 - TIM7)
 ...
 * @param  TIM_PWM_InitStruct: A pointer to the structure TIM_PWM_InitTypeDef that initializes the
 * PWM mode of TIMx.
 * @retval None
 */
