...
typedef enum {
    ...
    LED_FrameFre_B64Hz =
        (uint32_t)(0x00U << DDR_CON_DDRCK_Pos), /*!< The LED/LED frame frequency of typeB is 64Hz */
    LED_FrameFre_B128Hz =
        (uint32_t)(0x01U << DDR_CON_DDRCK_Pos), /*!< The LED/LED frame frequency of typeB is 128Hz*/
    LED_FrameFre_B256Hz =
        (uint32_t)(0x02U << DDR_CON_DDRCK_Pos), /*!< The LED/LED frame frequency of typeB is 256Hz*/
    LED_FrameFre_ACustom =
        (uint32_t)(DDR_CON_TRIMODE |
                   DDR_CON_TYPE), /*!< The LED/LED frame frequency of typeA is customized*/
    LED_FrameFre_BCustom =
        (uint32_t)(DDR_CON_TRIMODE), /*!< The LED/LED frame frequency of typeB is customized*/
...
typedef enum {
    ...
    LED_Duty_1_4_SEG4_27COM0_3 = (uint32_t)((0x03U << DDR_CFG_DUTY_Pos) |
                                            DDR_CFG_SCS), /*!< LED/LED display duty cycle: 1/4    */
} LED_Duty_TypeDef;

#    define IS_LED_DUTY(DUTY)                                                                      \
        (((DUTY) == LED_Duty_1_8) || ((DUTY) == LED_Duty_1_6) || ((DUTY) == LED_Duty_1_5) ||       \
         ((DUTY) == LED_Duty_1_4_SEG0_27COM4_7) || ((DUTY) == LED_Duty_1_4_SEG4_27COM0_3))
...
typedef enum {
    ...
    LED_Duty_1_4_SEG0_34COM4_7 =
        (uint32_t)(0x03U << DDR_CFG_DUTY_Pos), /*!< LED/LED display duty cycle: 1/4    */
    LED_Duty_1_4_SEG4_34COM0_3 = (uint32_t)((0x03U << DDR_CFG_DUTY_Pos) |
                                            DDR_CFG_SCS), /*!< LED/LED display duty cycle: 1/4    */
} LED_Duty_TypeDef;

#    define IS_LED_DUTY(DUTY)                                                                      \
        (((DUTY) == LED_Duty_1_8) || ((DUTY) == LED_Duty_1_6) || ((DUTY) == LED_Duty_1_5) ||       \
         ((DUTY) == LED_Duty_1_4_SEG0_34COM4_7) || ((DUTY) == LED_Duty_1_4_SEG4_34COM0_3))
#endif
/**
 * @}
 */
