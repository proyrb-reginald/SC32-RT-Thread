...
#define IS_GET_UART_FLAG(FLAG)                                                                     \
    (((FLAG) == UART_Flag_RX) || ((FLAG) == UART_Flag_TX) || ((FLAG) == UART_Flag_BK) ||           \
     ((FLAG) == UART_Flag_SLVYN) || ((FLAG) == UART_Flag_SLVHE) || ((FLAG) == UART_Flag_SY))
/**
 * @}
 */
 ...
 */
    ...
    defined(SC32f15xx) || defined(SC32R601)
typedef enum {
    UART_MASTER = (uint32_t)(0x00 << UART_CON_SLVEN_Pos |
                             (0x01 << UART_CON_FUNCSEL_Pos)), /*!< UART_LINMODE: UART_MASTER */
    UART_SLAVER = (uint32_t)(0x01 << UART_CON_SLVEN_Pos |
                             (0x01 << UART_CON_FUNCSEL_Pos)), /*!< UART_LINMODE: UART_SLAVER*/
} UART_LINMODE_TypeDef;

#    define IS_UART_LINMODE(LINMODE) (((LINMODE) == UART_MASTER) || ((LINMODE) == UART_SLAVER))
/**
 * @}
 */
...
#    define IS_UART_BKSIZE(BKSIZE) (((BKSIZE) == UART_BKSIZE_10) || ((BKSIZE) == UART_BKSIZE_13))
...
typedef struct {
    uint32_t UART_ClockFrequency; /*!<  Specifies the clock division.
                                                                                This parameter can
                                     be a value of @ref UART_ClockDivision */

    uint32_t UART_BaudRate; /*!< This member configures the UART communication baud rate.
                                            When UART_Mode is mode 0 This parameter can be a value
                               of @ref UART_Prescaler_TypeDef. */
