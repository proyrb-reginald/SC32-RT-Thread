...
typedef struct {
    ...
    __IO uint32_t
                  TWI_SPIx_ADD;  /*!< Reserved, 									Address offset: 0x08 */
...
typedef struct {
    ...
    __IO uint32_t
        PWM_DT[8]; /*!< PWM Duty register,@PWM PWM_DT[8] is Valied, 	Address offset: 0x30 */
} PWM_TypeDef;
/**
...
typedef struct {
    ...
    __IO uint32_t
        LEDPWM_DT[39]; /*!< PWM Duty register,@PWM PWM_DT[38] is Valied, 	Address offset: 0x30 */
} LEDPWM_TypeDef;
/**
...
typedef struct {
    ...
    __IO uint32_t RESERVED0[39]; /*!< Reserved, 									    	 Address
                                    offset: 0x04 			*/
...
typedef struct {
    ...
    __IO uint32_t CAN_CFG_STAT; /*!< CAN Configure Status register,                      Address
                                   offset: 0xA0 */
    __IO uint32_t
        CAN_RTIE; /*!< CAN Receive and Transmit Interrup register,         Address offset: 0xA4 */
    __IO uint32_t
        CAN_S_SEG; /*!< CAN Timing register (slow speed),                   Address offset: 0xA8 */
    __IO uint32_t
        CAN_F_SEG; /*!< CAN Timing register (fast speed),                   Address offset: 0xAC */
    __IO uint32_t
        CAN_EALCAP; /*!< CAN Error and Arbitration Lost Capture register,    Address offset: 0xB0 */
    ...
    __IO uint32_t TTCAN_WTRIG;    /*!< TTCAN Watch Trigger Time register,                  Address
                                     offset: 0xC8 */
    __IO uint32_t
        CAN_IDE; /*!< CAN IDE register,                                   Address offset: 0xCC */
    __IO uint32_t
        CAN_TIML; /*!< CAN TimestampLow Timer register,                    Address offset: 0xD0 */
    __IO uint32_t
