...
typedef enum {
    CAN_Disable_BRS =
        (uint8_t)(0x00 << CAN_TX_CTRL_BRS_Pos), /*!<Packet bit rate switching is disabled*/
    CAN_Enable_BRS =
        (uint8_t)(0x01 << CAN_TX_CTRL_BRS_Pos), /*!<The packet allows switching of the bit rate*/
} CAN_BRSMODE_Typedef;
...
typedef enum {
    CAN_TPSS_Enable =
        (uint32_t)(0x00 << CAN_CFG_STAT_TPSS_Pos), /*!<Enable automatic PTB retransmission*/
    CAN_TPSS_Disable =
        (uint32_t)(0x01 << CAN_CFG_STAT_TPSS_Pos), /*!<Disable automatic PTB retransmission*/
} CAN_PTB_AutoRetrans_TypeDef;
#    define IS_CAN_PTB_AutoRetrans(PTB_AutoRetrans)                                                \
        (((PTB_AutoRetrans) == CAN_TPSS_Enable) || ((PTB_AutoRetrans) == CAN_TPSS_Disable))
...
typedef enum {
    CAN_TSSS_Enable =
        (uint32_t)(0x00 << CAN_CFG_STAT_TSSS_Pos), /*!<Enable automatic STB retransmission*/
    CAN_TSSS_Disable =
        (uint32_t)(0x01 << CAN_CFG_STAT_TSSS_Pos), /*!<Disable STB automatic retransmission*/
} CAN_STB_AutoRetrans_TypeDef;
#    define IS_CAN_STB_AutoRetrans(STB_AutoRetrans)                                                \
        (((STB_AutoRetrans) == CAN_TSSS_Enable) || ((STB_AutoRetrans) == CAN_TSSS_Disable))
...
#    define IS_CANTBUF(CANTBUF) (((CANTBUF) == CAN_TBUFTx_PTB) || ((CANTBUF) == CAN_TBUFTx_STB))
...
#    define IS_CANSTBBUF(CANSTBBUF)                                                                \
        (((CANSTBBUF) == CAN_STBBUF_Empty) || ((CANSTBBUF) == CAN_STBBUF_LessOrEqual_4) ||         \
         ((CANSTBBUF) == CAN_STBBUF_GreaterOrEqual_5) || ((CANSTBBUF) == CAN_STBBUF_Equal_8))
...
#    define IS_CANTXEN(CANTXEN) (((CANTXEN) == CAN_TxDisable) || ((CANTXEN) == CAN_TxEnable))
...
#    define IS_CANRXEN(CANRXEN) (((CANRXEN) == CAN_RxDisable) || ((CANRXEN) == CAN_RxEnable))
...
#    define IS_FliterFrame(FliterFrame)                                                            \
        (((FliterFrame) == CAN_Fliter_Standard) || ((FliterFrame) == CAN_Fliter_Extension) ||      \
...
#    define IS_CANTSMODE(CANTSMODE) (((CANTSMODE) == CAN_TxFIFO) || ((CANTSMODE) == CAN_IDPriority))
...
typedef enum {
    ...
    CAN_TSIEEN = (uint32_t)(0x01 << CAN_RTIE_TSIE_Pos),   /*!<The STB transmission completion
                                                             interrupt was enabled*/
    CAN_TPIEEN = (uint32_t)(0x01 << CAN_RTIE_TPIE_Pos),   /*!<The interruption of PTB transmission
                                                             completion was enabled*/
    CAN_RAFIEEN = (uint32_t)(0x01 << CAN_RTIE_RAFIE_Pos), /*!<RB slots Threshold warning Indicates
                                                             the interrupt function*/
    CAN_RFIEEN =
        (uint32_t)(0x01 << CAN_RTIE_RFIE_Pos), /*!<RB full interrupt was enabled. Procedure*/
    CAN_ROIEEN =
        (uint32_t)(0x01 << CAN_RTIE_ROIE_Pos), /*!<Overflow interrupt was enabled. Procedure*/
    CAN_RIEEN =
        (uint32_t)(0x01 << CAN_RTIE_RIE_Pos), /*!<The receiving interrupt function was enabled*/
    CAN_BEIEEN = (uint32_t)(0x01 << CAN_RTIE_BEIE_Pos), /*!<Bus error interrupt enabled*/
    CAN_ALIEEN = (uint32_t)(0x01 << CAN_RTIE_ALIE_Pos), /*!<The arbitration loss interruption
                                                           function was enabled*/
    CAN_EPIEEN = (uint32_t)(0x01 << CAN_RTIE_EPIE_Pos), /*!<Error passive interrupt enable bit*/
} CAN_INT_TypeDef;
#    define IS_CAN_INT(CAN_INT)                                                                    \
        (((CAN_INT) == CAN_RIEEN) || ((CAN_INT) == CAN_ROIEEN) || ((CAN_INT) == CAN_RFIEEN) ||     \
         ((CAN_INT) == CAN_RAFIEEN) || ((CAN_INT) == CAN_TPIEEN) || ((CAN_INT) == CAN_TSIEEN) ||   \
         ((CAN_INT) == CAN_EIEEN) || ((CAN_INT) == CAN_ALIEEN) || ((CAN_INT) == CAN_BEIEEN) ||     \
         ((CAN_INT) == CAN_INTEN) || ((CAN_INT) == CAN_EPIEEN))
...
#    define IS_CANTimeStamp(CANTimeStamp)                                                          \
        (((CANTimeStamp) == CAN_TimeStampDisable) || ((CANTimeStamp) == CAN_TimeStampEnable))
/** @brief CAN Indicates whether to enable timestamp counting
 * @{
 */
typedef enum {
    CAN_TimeStampCntDisable =
        (uint16_t)(0x00 << CAN_IDE_TIMEN_Pos), /*!<Disable the timestamp counting function*/
    CAN_TimeStampCntEnable =
        (uint16_t)(0x01 << CAN_IDE_TIMEN_Pos), /*!<Enable the timestamp counting function*/
...
typedef enum {
    CAN_TimeStampPosition_SOF =
        (uint16_t)(0x00 << CAN_ACFCTRL_TIMEPOS_Pos), /*!<Select the frame start as the timestamp
                                                        location*/
    CAN_TimeStampPosition_EOF =
        (uint16_t)(0x01 << CAN_ACFCTRL_TIMEPOS_Pos), /*!<Select the end of frame as the timestamp
                                                        location*/
...
#    define IS_CAN_TransMod(CAN_TransMod)                                                          \
        (((CAN_TransMod) == CAN_TransMod_TPE) || ((CAN_TransMod) == CAN_TransMod_TSONE) ||         \
...
#    define IS_CANFD_ISO_MODE(ISO_MODE) (((ISO_MODE) == CAN_BOSCH) || ((ISO_MODE) == CAN_ISO))
/** @brief CAN BaudRate
 * @{
 */
typedef enum {
...
typedef struct {
    ...
    uint32_t
        CANFDFrame; /*!< This member configures CAN Frame.
                                         This parameter can be a value of FD_Mode_on/FD_Mode_off */

    uint32_t
        CANROMSelect; /*!< This member configures CAN ROMSelect.
                                         This parameter can be a value of @ref CANROM_TypeDef */
    uint32_t
        CAN_MOD; /*!< This member configures CAN  mode.
    ...
    uint16_t
        CANTBUFSelect; /*!< This member configures CAN Sending mode.
