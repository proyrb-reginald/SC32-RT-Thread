...
typedef enum {
    PWM_FDMode_Latch =
        (uint16_t)(0x00U << PWM_FLT_FLTMD_Pos), /*!< PWM fault detection mode: Latch mode */
    PWM_FDMode_Immediate =
        (uint16_t)(0x01U << PWM_FLT_FLTMD_Pos), /*!< PWM fault detection mode: Immediate mode */
} PWM_FDMode_TypeDef;

#define IS_PWM_FDMODE(MODE) (((MODE) == PWM_FDMode_Latch) || ((MODE) == PWM_FDMode_Immediate))
/**
 * @}
 */
...
typedef enum {
    PWM_FDVoltage_Low =
        (uint16_t)(0x00U << PWM_FLT_FLTTV_Pos), /*!< PWM fault detection Voltage:Low level */
    PWM_FDVoltage_High =
        (uint16_t)(0x01U << PWM_FLT_FLTTV_Pos), /*!< PWM fault detection Voltage:High level */
...
typedef enum {
    PWM_FilteringTime_0us =
        (uint16_t)(0x00U << PWM_FLT_FLTDT_Pos), /*!< PWM fault detection input signal filtering time
                                                   is 0us */
    PWM_FilteringTime_1us =
        (uint16_t)(0x01U << PWM_FLT_FLTDT_Pos), /*!< PWM fault detection input signal filtering time
                                                   is 1us */
    PWM_FilteringTime_4us =
        (uint16_t)(0x02U << PWM_FLT_FLTDT_Pos), /*!< PWM fault detection input signal filtering time
                                                   is 4us */
    PWM_FilteringTime_16us =
        (uint16_t)(0x03U << PWM_FLT_FLTDT_Pos), /*!< PWM fault detection input signal filtering time
                                                   is 16us */
...
typedef struct {
    uint16_t PWM_Prescaler; /*!<  Specifies the predivision.
                               ...
                               value of @ref PWM_Prescaler_TypeDef */

    uint16_t PWM_AlignedMode; /*!< Specifies the aligne mode.
                                                                            This parameter can be a
                                 value of @ref PWM_AlignedMode_TypeDef */

    uint16_t PWM_WorkMode; /*!< Specifies the work mode.
                                                                                    This parameter
                              can be a value of @ref PWM_WorkMode_TypeDef */
    ...
    uint32_t PWM_OutputChannel; /*!< Specifies the output Channel.
                                                                             This parameter can be a
                                   value of @ref PWM_CHANNEL_Typedef */

    uint32_t PWM_LowPolarityChannl; /*!< Specifies the invert Channel.
                                                                                 This parameter can
                                       be a value of @ref PWM_CHANNEL_Typedef */
} PWM_InitTypeDef;
/**
 * @}
 */
