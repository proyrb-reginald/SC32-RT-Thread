...
#    define IS_TWI_ACK(STATE) (((STATE) == TWI_Ack_Disable) || ((STATE) == TWI_Ack_Enable))
/**
 * @}
 */
...
#        define IS_TWI_PRESCALER(PRESCALER)                                                        \
            (((PRESCALER) == TWI0_PRESCALER_4) || ((PRESCALER) == TWI0_PRESCALER_8) ||             \
             ...
             ((PRESCALER) == TWI0_PRESCALER_64) || ((PRESCALER) == TWI0_PRESCALER_128) ||          \
             ((PRESCALER) == TWI0_PRESCALER_256) || ((PRESCALER) == TWI0_PRESCALER_512) ||         \
             ((PRESCALER) == TWI0_PRESCALER_1024) || ((PRESCALER) == TWI0_PRESCALER_2048) ||       \
             ((PRESCALER) == TWI0_PRESCALER_4096) || ((PRESCALER) == TWI1_Prescaler_1) ||          \
             ((PRESCALER) == TWI1_Prescaler_2) || ((PRESCALER) == TWI1_Prescaler_4) ||             \
             ((PRESCALER) == TWI1_Prescaler_8) || ((PRESCALER) == TWI1_Prescaler_16) ||            \
             ((PRESCALER) == TWI1_Prescaler_32) || ((PRESCALER) == TWI1_Prescaler_64) ||           \
             ((PRESCALER) == TWI1_Prescaler_128) || ((PRESCALER) == TWI1_Prescaler_256) ||         \
             ((PRESCALER) == TWI1_Prescaler_512) || ((PRESCALER) == TWI1_Prescaler_1024) ||        \
             ((PRESCALER) == TWI1_Prescaler_2048) || ((PRESCALER) == TWI1_Prescaler_4096))
#    endif
/**
 * @}
 */
...
#    define IS_TWI_GENERALCALL(GENERALCALL)                                                        \
        (((GENERALCALL) == TWI_GeneralCall_Disable) || ((GENERALCALL) == TWI_GeneralCall_Enable))
/**
 * @}
 */
...
#    define IS_TWI_DMAREQ(DMAREQ) (((DMAREQ) == TWI_DMAReq_RX) || ((DMAREQ) == TWI_DMAReq_TX))
/**
 * @}
 */
...
#    define IS_TWI_FLAG(FLAG)                                                                      \
        (((FLAG) == TWI_FLAG_TXRXnE) || ((FLAG) == TWI_FLAG_GCA) || ((FLAG) == TWI_FLAG_QTWIF))
...
#    define IS_TWI_ALL_PERIPH(PERIPH)                                                              \
        (((PERIPH) == TWI0) || ((PERIPH) == TWI1) || ((PERIPH) == TWI2) || ((PERIPH) == TWI3))
#endif
/**
 * @}
 */
...
typedef struct {
    uint16_t
        TWI_Ack; /*!< This member configures TWI Ack.
