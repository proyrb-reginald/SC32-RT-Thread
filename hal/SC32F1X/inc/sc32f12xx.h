...
#        define LXT_VALUE                                                                          \
            ((uint32_t)32768) /*!< Default value of the External Low speed oscillator in Hz */
#    endif                    /* HXT_VALUE */
 ...
 */
/**
 * @brief UART0-1 for APB0,UART2 for APB1,UART3 for APB2,UART0/2/3 Peripheral offset =0x20,UART1
 * Peripheral offset=0x80
 */
typedef struct {
...
typedef struct {
    __IO uint32_t
        PWM_CON; /*!< Pwm Control register,                          Address offset: 0x00 */
    __IO uint32_t
        PWM_CHN; /*!< PWM Channel register,                         Address offset: 0x04 */
    __IO uint32_t
        PWM_STS; /*!< PWM Status register,                          Address offset: 0x08 */
    __IO uint32_t
        PWM_INV; /*!< PWM Inverse register,                         Address offset: 0x0C */
    __IO uint32_t
        PWM_DFR; /*!< PWM Dead space register,                      Address offset: 0x10 */
    __IO uint32_t
        PWM_FLT; /*!< PWM FaiLure detection register,               Address offset: 0x14 */
    __IO uint32_t
        PWM_CYCLE; /*!< PWM Cycles register,                          Address offset: 0x18 */
    __IO uint32_t
        RESERVED[5]; /*!< Reserved,                                     Address offset: 0x1C */
    __IO uint32_t
        PWM_DT[8]; /*!< PWM Duty register,@PWM0 PWM_DT[8] is Valied,  Address offset: 0x30 */
} PWM_TypeDef;
/**
 * @brief LEDPWM for APB2,LEDPWM Peripheral offset=0x300,
 */
typedef struct {
    __IO uint32_t LEDPWM_CON;    /*!< LEDPWM Control register,                               Address
                                    offset: 0x00 */
    __IO uint32_t LEDPWM_CHN;    /*!< LEDPWM Channel register,                              Address
                                    offset: 0x04 */
    __IO uint32_t LEDPWM_STS;    /*!< LEDPWM Status register,                                Address
                                    offset: 0x08 */
    __IO uint32_t LEDPWM_INV;    /*!< LEDPWM Inverse register,                              Address
                                    offset: 0x0C */
    __IO uint32_t LEDPWM_DFR;    /*!< LEDPWM Dead space register,                            Address
                                    offset: 0x10 */
    __IO uint32_t LEDPWM_FLT;    /*!< LEDPWM FaiLure detection register,                     Address
                                    offset: 0x14 */
    __IO uint32_t LEDPWM_CYCLE;  /*!< LEDPWM Cycles register,                                Address
                                    offset: 0x18 */
    __IO uint32_t RESERVED[5];   /*!< Reserved,                                           Address
                                    offset: 0x1C~0x2C */
    __IO uint32_t LEDPWM_DT[32]; /*!< LEDPWM Duty register,@LEDPWM LEDPWM_DT[31] is Valied,  Address
                                    offset: 0x30 */
} LEDPWM_TypeDef;
/**
...
typedef struct {
    ...
    __IO uint32_t RESERVED1[39]; /*!< Reserved,                                            Address
                                    offset: 0x14 */
