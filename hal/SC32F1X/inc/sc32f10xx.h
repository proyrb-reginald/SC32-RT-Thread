...
typedef struct {
    ...
    __IO uint32_t
                  RESERVED0[2]; /*!< Reserved, 									Address offset: 0x1C */
    __IO uint32_t LEDPWM_CYCLE; /*!< LEDPWM Cycles register,  			Address offset: 0x18 */
    __IO uint32_t
                  RESERVED1[5];  /*!< Reserved, 									Address offset: 0x1C */
    __IO uint32_t LEDPWM_DT[32]; /*!< LEDPWM Duty register,@LEDPWM0 LEDPWM_DT[8] is Valied,
                                    Address offset: 0x30 */
} LEDPWM_TypeDef;
...
typedef struct {
    ...
    __IO uint32_t DDR_CFG;   /*!< Display Drive Config register, 			                Address
                                offset: 0x04 */
    __IO uint32_t SEG_EN;    /*!< Segment IO Enable register, 				                  Address
                                offset: 0x08 */
    ...
    __IO uint32_t RESERVED1[39]; /*!< Reserved,                                            Address
                                    offset: 0x14 */
    __IO uint32_t SEGRn[28];     /*!< COM port display drive output function register, 		Address
                                    offset: 0x50 */
} LCD_LED_TypeDef;
