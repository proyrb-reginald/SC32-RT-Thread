...
typedef enum {
    ...
    DMA_DataSize_HalfWord =
        ((uint32_t)0x01U << DMA_CFG_TXWIDTH_Pos), /*!< Peripheral data alignment: HalfWord */
    DMA_DataSize_Word =
...
typedef enum {
    ...
    DMA_TargetMode_INC_CIRC =
        ((uint32_t)0x03U << DMA_CFG_DAINC_Pos), /*!< DMA Target Mode: Address increase loop */
...
typedef enum {
    ...
    DMA_SourceMode_INC_CIRC =
        ((uint32_t)0x03U << DMA_CFG_SAINC_Pos), /*!< DMA Source Mode: Address increase loop */
...
typedef enum {
    ...
    DMA_Burst_1B =
        (((uint16_t)0x07U << DMA_CFG_BURSIZE_Pos) | DMA_CFG_TPTYPE), /*!< Burst Mode: rease 1 */
    DMA_Burst_2B =
        (((uint16_t)0x06U << DMA_CFG_BURSIZE_Pos) | DMA_CFG_TPTYPE), /*!< Burst Mode: rease 2 */
    DMA_Burst_4B =
        (((uint16_t)0x05U << DMA_CFG_BURSIZE_Pos) | DMA_CFG_TPTYPE), /*!< Burst Mode: rease 4 */
    DMA_Burst_8B =
        (((uint16_t)0x04U << DMA_CFG_BURSIZE_Pos) | DMA_CFG_TPTYPE), /*!< Burst Mode: rease 8 */
    DMA_Burst_16B =
        (((uint16_t)0x03U << DMA_CFG_BURSIZE_Pos) | DMA_CFG_TPTYPE), /*!< Burst Mode: rease 16 */
    DMA_Burst_32B =
        (((uint16_t)0x02U << DMA_CFG_BURSIZE_Pos) | DMA_CFG_TPTYPE), /*!< Burst Mode: rease 32 */
    DMA_Burst_64B =
        (((uint16_t)0x01U << DMA_CFG_BURSIZE_Pos) | DMA_CFG_TPTYPE), /*!< Burst Mode: rease 64 */
    DMA_Burst_128B =
        (((uint16_t)0x00U << DMA_CFG_BURSIZE_Pos) | DMA_CFG_TPTYPE), /*!< Burst Mode: rease 128 */
} DMA_Burst_TypeDef;

#define IS_DMA_BURST(BURST)                                                                        \
    (((BURST) == DMA_Burst_Disable) || ((BURST) == DMA_Burst_1B) || ((BURST) == DMA_Burst_2B) ||   \
     ((BURST) == DMA_Burst_4B) || ((BURST) == DMA_Burst_8B) || ((BURST) == DMA_Burst_16B) ||       \
     ((BURST) == DMA_Burst_32B) || ((BURST) == DMA_Burst_64B) || ((BURST) == DMA_Burst_128B))
/**
 * @}
 */
...
typedef enum {
    ...
    DMA_Request_TIM1_CAPF =
        ((uint32_t)0x0022U << DMA_CFG_REQSRC_Pos), /*!< DMA Requtest: TIM1 Falling edge capture */
    DMA_Request_TIM1_CAPR =
        ((uint32_t)0x0023U << DMA_CFG_REQSRC_Pos), /*!< DMA Requtest: TIM1 Rising edge capture  */
    DMA_Request_TIM2_TI = ((uint32_t)0x0024U << DMA_CFG_REQSRC_Pos), /*!< DMA Requtest: TIM2 TI */
    DMA_Request_TIM2_CAPF =
        ((uint32_t)0x0025U << DMA_CFG_REQSRC_Pos), /*!< DMA Requtest: TIM2 Falling edge capture */
    DMA_Request_TIM2_CAPR =
        ((uint32_t)0x0026U << DMA_CFG_REQSRC_Pos), /*!< DMA Requtest: TIM2 Rising edge capture  */
    DMA_Request_TIM6_TI = ((uint32_t)0x0030U << DMA_CFG_REQSRC_Pos), /*!< DMA Requtest: TIM6 TI */
    DMA_Request_TIM6_CAPF =
        ((uint32_t)0x0031U << DMA_CFG_REQSRC_Pos), /*!< DMA Requtest: TIM6 Falling edge capture */
    DMA_Request_TIM6_CAPR =
        ((uint32_t)0x0032U << DMA_CFG_REQSRC_Pos), /*!< DMA Requtest: TIM6 Rising edge capture  */
...
typedef enum {
    ...
    DMA_State_BUSY =
        ((uint32_t)0x02U << DMA_STS_STATUS_Pos), /*!< DMA reads the source address data and writes
...
typedef enum {
    ...
    DMA_FLAG_TCIF =
        ((uint8_t)DMA_STS_TCIF), /*!< DMA FLAG: Transmission completion interrupt flag bit */
...
#define IS_GET_DMA_FLAG(FLAG)                                                                      \
    (((FLAG) == DMA_FLAG_GIF) || ((FLAG) == DMA_FLAG_TCIF) || ((FLAG) == DMA_FLAG_HTIF) ||         \
     ((FLAG) == DMA_FLAG_TEIF))
/**
 * @}
 */
...
typedef struct {
    ...
    uint16_t DMA_DataSize; /*!< Specifies the DMA data width.
                              ...
                              value of @ref DMA_DataSize_TypeDef */
    ...
    uint32_t
        DMA_BufferSize; /*!< Specifies the buffer size, in data unit, of the specified Stream.*/

    uint32_t DMA_Request; /*!< DMA request source.
                                                                     This parameter can be a value
                             of @ref DMA_Request_TypeDef */
...
#    define IS_DMA_ALL_PERIPH(PERIPH)                                                              \
        (((PERIPH) == DMA0) || ((PERIPH) == DMA1) || ((PERIPH) == DMA2) || ((PERIPH) == DMA3))
#elif defined(SC32f12xx) || defined(SC32R805) || defined(SC32R806)
