...
typedef enum {
    QEP_Mode_Orthogonal =
        (uint32_t)(0x00U << QEP_CON_QSRC_Pos), /*!< Location count source selection: Orthogonal  */
    QEP_Mode_Direction =
        (uint32_t)(0x01U << QEP_CON_QSRC_Pos), /*!< Location count source selection: Direction   */
    QEP_Mode_Dipulse =
        (uint32_t)(0x02U << QEP_CON_QSRC_Pos), /*!< Location count source selectione: Dipulse     */
} QEP_Mode_TypeDef;
...
#define IS_QEP_CEN(CEN)                                                                            \
    (((CEN) == QEP_CEN_Default) || ((CEN) == QEP_CEN_Rising) || ((CEN) == QEP_CEN_Falling))
/**
 * @}
 */
...
#define IS_QEP_GATE(GATE)                                                                          \
    (((GATE) == QEP_GATE_Default) || ((GATE) == QEP_GATE_QA) || ((GATE) == QEP_GATE_QB) ||         \
     ((GATE) == QEP_GATE_QI))
/**
 * @}
 */
...
#define IS_QEP_QEPnI(INDEX) (((QEPnI) == QEP_QEPnI_Forward) || ((QEPnI) == QEP_QEPnI_Reverse))
/** @defgroup QEP_SWAP QEP Swap orthogonal input directions
 * @{
 */
typedef enum {
    QEP_SWAP_Default = (uint32_t)(0X00U << QEP_CON_SWAP_Pos),  /*!< QEP input directions: Orthogonal
                                                                  clock inputs are not swap    */
    QEP_SWAP_Exchange = (uint32_t)(0X01U << QEP_CON_SWAP_Pos), /*!< QEP input directions: Orthogonal
...
typedef enum {
    QEP_Flag_PCU =
        (uint8_t)QEP_STS_PCUIF, /*!< QEP Flag:Location counter underflow interrupted flag*/
...
typedef struct {
    uint32_t QEP_Mode; /*!<   This member configures QEP Mode.
                                                                                  This parameter can
                          be a value of @ref QEP_Mode_TypeDef */

    uint32_t
        QEP_GATE; /*!<  This member configures QEP GATE.
                                         This parameter can be a value of @ref QEP_GATE_TypeDef */

    uint32_t
        QEP_CEN; /*!<  This member configures QEP CEN.
