...
#    define IS_SPI_DATASIZE(SIZE) (((SIZE) == SPI_DataSize_8B) || ((SIZE) == SPI_DataSize_16B))
/**
 * @}
 */
...
#    define IS_SPI_FIRSTBIT(BIT) (((BIT) == SPI_FirstBit_MSB) || ((BIT) == SPI_FirstBit_LSB))
/**
 * @}
 */
...
#    define IS_SPI_PRESCALER(PRESCALER)                                                                                          \
        (((PRESCALER) == SPI_Prescaler_1) || ((PRESCALER) == SPI_Prescaler_2) || ((PRESCALER) == SPI_Prescaler_4) ||             \
         ((PRESCALER) == SPI_Prescaler_8) || ((PRESCALER) == SPI_Prescaler_16) || ((PRESCALER) == SPI_Prescaler_32) ||           \
         ((PRESCALER) == SPI_Prescaler_64) || ((PRESCALER) == SPI_Prescaler_128) || ((PRESCALER) == SPI_Prescaler_256) ||        \
         ((PRESCALER) == SPI_Prescaler_512) || ((PRESCALER) == SPI_Prescaler_1024))
...
#        define IS_SPI_LIST1_PINREMAP(REMAP)                                                                                     \
            (((REMAP) == SPI_PinRemap_Default) || ((REMAP) == SPI_PinRemap_A) || ((REMAP) == SPI_PinRemap_B))

#        define IS_SPI_LIST2_PINREMAP(REMAP) (((REMAP) == SPI_PinRemap_Default) || ((REMAP) == SPI_PinRemap_A))
...
#    define IS_SPI_IT(IT)                                                                                                        \
        (((IT) == SPI_IT_INTEN) || ((IT) == SPI_IT_RXNE) || ((IT) == SPI_IT_TB) || ((IT) == SPI_IT_RX) ||                        \
         ((IT) == SPI_IT_RXH) || ((IT) == SPI_IT_TXH) || ((IT) == SPI_IT_TBIE))
...
#    define IS_SPI_FLAG(FLAG)                                                                                                    \
        (((FLAG) == SPI_Flag_SPIF) || ((FLAG) == SPI_Flag_RINEIF) || ((FLAG) == SPI_Flag_TXEIF) || ((FLAG) == SPI_Flag_RXFIF) || \
         ((FLAG) == SPI_Flag_RXHIF) || ((FLAG) == SPI_Flag_TXHIF) || ((FLAG) == SPI_Flag_WCOL))
...
#    define IS_SPI_DMAREQ(DMAREQ) (((DMAREQ) == SPI_DMAReq_RX) || ((DMAREQ) == SPI_DMAReq_TX))
/**
 * @}
 */
...
#    elif defined(SC32f12xx) || defined(SC32R805) || defined(SC32R806)
#        define IS_SPI_ALL_PERIPH(PERIPH) (((PERIPH) == SPI0) || ((PERIPH) == SPI1) || ((PERIPH) == SPI2))
#    endif
...
typedef enum {
    ...
    SPI_CPHA_2Edge = (uint16_t)(0X01U << SPI0_CON_CPHA_Pos), /*!< SPI Clock Phase:The second edge
                                                                signal is triggered    */
} SPI_CPHA_TypeDef;
...
#    define IS_SPI_PRESCALER(PRESCALER)                                                                                          \
        (((PRESCALER) == SPI_Prescaler_1) || ((PRESCALER) == SPI_Prescaler_2) || ((PRESCALER) == SPI_Prescaler_4) ||             \
         ((PRESCALER) == SPI_Prescaler_8) || ((PRESCALER) == SPI_Prescaler_16) || ((PRESCALER) == SPI_Prescaler_32) ||           \
         ((PRESCALER) == SPI_Prescaler_64) || ((PRESCALER) == SPI_Prescaler_128) || ((PRESCALER) == SPI_Prescaler_256) ||        \
         ((PRESCALER) == SPI_Prescaler_512) || ((PRESCALER) == SPI_Prescaler_1024) || ((PRESCALER) == SPI_Prescaler_2048) ||     \
...
#    define IS_SPI_FLAG(FLAG)                                                                                                    \
        (((FLAG) == SPI_Flag_SPIF) || ((FLAG) == SPI_Flag_RINEIF) || ((FLAG) == SPI_Flag_TXEIF) || ((FLAG) == SPI_Flag_RXFIF) || \
         ((FLAG) == SPI_Flag_RXHIF) || ((FLAG) == SPI_Flag_TXHIF) || ((FLAG) == SPI_Flag_WCOL) || ((FLAG) == SPI_FLAG_QTWIF))
/**
 * @}
 */
...
typedef enum {
    ...
    SPI_DataSize_16B = (uint32_t)(0X01U << TWI_QSPIx_CON_DWIDTH_Pos), /*!< SPI Data Size:Set data
    ...
    SPI_DataSize_32B = (uint32_t)(0X03U << TWI_QSPIx_CON_DWIDTH_Pos), /*!< SPI Data Size:Set data
                                                                         frame format to 16bit   */
} SPI_DataSize_TypeDef;
 ...
 */
typedef enum {
    SPI_CPHA_1Edge = (uint32_t)(0X00U << TWI_SPIx_CON_CPHA_Pos), /*!< SPI Clock Phase:The first edge
                                                                    signal is triggered   */
    SPI_CPHA_2Edge = (uint32_t)(0X01U << TWI_SPIx_CON_CPHA_Pos), /*!< SPI Clock Phase:The second
...
typedef enum {
    ...
    SPI_CPOL_High = (uint32_t)(0X01U << TWI_SPIx_CON_CPOL_Pos), /*!< SPI Clock Polarity:It is high
                                                                   in the idle state    */
} SPI_CPOL_TypeDef;
...
#    define IS_SPI_IT(IT)                                                                                                        \
        (((IT) == SPI_IT_INTEN) || ((IT) == SPI_IT_RXNE) || ((IT) == SPI_IT_TB) || ((IT) == SPI_IT_RX) ||                        \
         ((IT) == SPI_IT_RXH) || ((IT) == SPI_IT_TXH) || ((IT) == SPI_IT_TBIE) || ((IT) == SPI_IT_QTWIE))
/**
 * @}
 */
...
#    define IS_SPI_FLAG(FLAG)                                                                                                    \
        (((FLAG) == SPI_Flag_RINEIF) || ((FLAG) == SPI_Flag_TXEIF) || ((FLAG) == SPI_Flag_RXFIF) ||                              \
         ((FLAG) == SPI_Flag_RXHIF) || ((FLAG) == SPI_Flag_TXHIF) || ((FLAG) == SPI_Flag_WCOL) || ((FLAG) == SPI_FLAG_QTWIF))
/**
 * @}
 */
...
#    define IS_SPI_ALL_PERIPH(PERIPH) (((PERIPH) == SPI0) || ((PERIPH) == SPI1) || ((PERIPH) == SPI2) || ((PERIPH) == SPI3))
