...
#define IS_LEDPWM_PRESCALER(PRESCALER)                                                             \
    (((PRESCALER) == LEDPWM_PRESCALER_DIV1) || ((PRESCALER) == LEDPWM_PRESCALER_DIV2) ||           \
     ...
     ((PRESCALER) == LEDPWM_PRESCALER_DIV16) || ((PRESCALER) == LEDPWM_PRESCALER_DIV32) ||         \
     ((PRESCALER) == LEDPWM_PRESCALER_DIV64) || ((PRESCALER) == LEDPWM_PRESCALER_DIV128) ||        \
...
typedef struct {
    uint16_t LEDPWM_Prescaler; /*!<  Specifies the predivision.
                                  ...
                                  value of @ref LEDPWM_Prescaler_TypeDef */

    uint16_t LEDPWM_AlignedMode; /*!< Specifies the aligne mode.
                                                                            This parameter can be a
                                    value of @ref LEDPWM_AlignedMode_TypeDef */
    ...
    uint64_t LEDPWM_OutputChannel; /*!< Specifies the output Channel.
                                                                             This parameter can be a
                                      value of @ref LEDPWM_Channel_Typedef */
