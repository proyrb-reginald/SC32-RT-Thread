...
#define IS_CRC_INPUTDATA_FORMAT(FORMAT)                                                            \
    (((FORMAT) == CRC_InputData_Format_UNDEFINED) || ((FORMAT) == CRC_InputData_Format_BYTES) ||   \
...
typedef struct {
    uint16_t
        DefaultPolynomialUse; /*!< This parameter is a value of @ref DEFAULT_Polynomial_TypeDef and
    ...
    uint16_t
        DefaultInitValueUse; /*!< This parameter is a value of @ref DEFAULT_InitValue_TypeDef and
    ...
    uint32_t CRCSize; /*!< This parameter is a value of @ref CRC_POLYSIZE_TypeDef and indicates CRC
                         length. */
