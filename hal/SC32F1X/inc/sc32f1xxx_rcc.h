...
#        define IS_RCC_SYSCLKSOURCE(SOURCE)                                                        \
            (((SOURCE) == RCC_SYSCLKSource_HIRC) || ((SOURCE) == RCC_SYSCLKSource_LIRC) ||         \
             ((SOURCE) == RCC_SYSCLKSource_HXT) || ((SOURCE) == RCC_SYSCLKSource_PLLRCLK) ||       \
...
#        define IS_RCC_SYSCLKSOURCE(SOURCE)                                                        \
            (((SOURCE) == RCC_SYSCLKSource_HIRC_2) || ((SOURCE) == RCC_SYSCLKSource_LIRC) ||       \
             ((SOURCE) == RCC_SYSCLKSource_HXT) || ((SOURCE) == RCC_SYSCLKSource_HIRC) ||          \
             ((SOURCE) == RCC_SYSCLKSource_LXT))
...
#        define IS_RCC_SYSCLKSOURCE(SOURCE)                                                        \
            (((SOURCE) == RCC_SYSCLKSource_HIRC) || ((SOURCE) == RCC_SYSCLKSource_LIRC) ||         \
             ((SOURCE) == RCC_SYSCLKSource_HIRC_2) || ((SOURCE) == RCC_SYSCLKSource_LXT))
...
typedef enum {
    ...
    RCC_SysTickSource_LXT = (uint8_t)(0X04 << RCC_CFG1_STCLKSEL_Pos), /*!< SysTickCLK clock = LXT */
    RCC_SysTickSource_HCLK = (uint8_t)(0X01), /*!< SysTickCLK clock = HCLK */
} RCC_SysTickSource_TypeDef;

#    define IS_RCC_SYSTICKSOURCE(SOURCE)                                                           \
        (((SOURCE) == RCC_SysTickSource_HCLK_DIV8) || ((SOURCE) == RCC_SysTickSource_HIRC_DIV2) || \
         ((SOURCE) == RCC_SysTickSource_HXT_DIV2) || ((SOURCE) == RCC_SysTickSource_LIRC) ||       \
         ((SOURCE) == RCC_SysTickSource_LXT) || ((SOURCE) == RCC_SysTickSource_HCLK))
/**
 * @}
 */
...
#    define IS_RCC_PCLK(PCLK)                                                                      \
        (((PCLK) == RCC_HCLK_Div1) || ((PCLK) == RCC_HCLK_Div2) || ((PCLK) == RCC_HCLK_Div4) ||    \
         ((PCLK) == RCC_HCLK_Div8) || ((PCLK) == RCC_HCLK_Div16) || ((PCLK) == RCC_HCLK_Div32) ||  \
...
#        define RCC_LCDLEDCLKSOURCE(SOURCE)                                                        \
            (((SOURCE) == RCC_LCDLEDCLKSource_LIRC) || ((SOURCE) == RCC_LCDLEDCLKSource_LXT))
#    endif
/**
 * @}
 */
...
#        define RCC_PWM0CLKSOURCE(SOURCE)                                                          \
            (((SOURCE) == RCC_PWM0CLKSource_PCLK) || ((SOURCE) == RCC_PWM0CLKSource_Div1HIRC))
