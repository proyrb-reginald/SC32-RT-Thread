...
#    define IS_INT_INTSEL(INTSEL)                                                                  \
        (((INTSEL) == INT_INTSEL_PA) || ((INTSEL) == INT_INTSEL_PB) || ((INTSEL) == INT_INTSEL_PC))
...
typedef struct {
    uint16_t INT_Channel; /*!<  Specifies the INT channel.
                                                                                    This parameter
                             can be a value of @ref INT_ClockDivision */

    uint16_t
        INT_Trigger; /*!< Specifies the external interrupt triggering mode.
