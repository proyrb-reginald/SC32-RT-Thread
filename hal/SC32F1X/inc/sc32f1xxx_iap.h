...
/** @brief It is used to control the enabling or disabling state of IAP operations and includes
 * security-related flags or keys
 * @{
 */
typedef enum {
    IAP_ENABLE   = 0x69,
...
#    define IS_IAP_BTLD(BTLD)                                                                      \
        (((BTLD) == IAP_BTLD_APPROM) || ((BTLD) == IAP_BTLD_LDROM) || ((BTLD) == IAP_BTLD_SRAM))
/**
 * @}
 */
/** @defgroup IAP_Keys
