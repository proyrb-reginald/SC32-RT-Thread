...
#    define IS_ADC_PRESCALER(PRESCALER)                                                            \
        (((PRESCALER) == ADC_Prescaler_3CLOCK) || ((PRESCALER) == ADC_Prescaler_6CLOCK) ||         \
         ((PRESCALER) == ADC_Prescaler_16CLOCK) || ((PRESCALER) == ADC_Prescaler_32CLOCK))
#elif defined(SC32f15xx) || defined(SC32R601)
#    define IS_ADC_PRESCALER(PRESCALER)                                                            \
        (((PRESCALER) == ADC_Prescaler_3CLOCK) || ((PRESCALER) == ADC_Prescaler_6CLOCK) ||         \
         ((PRESCALER) == ADC_Prescaler_9CLOCK) || ((PRESCALER) == ADC_Prescaler_15CLOCK) ||        \
         ((PRESCALER) == ADC_Prescaler_30CLOCK) || ((PRESCALER) == ADC_Prescaler_60CLOCK) ||       \
         ((PRESCALER) == ADC_Prescaler_120CLOCK) || ((PRESCALER) == ADC_Prescaler_480CLOCK))
#endif
/**
 * @}
 */
...
#if defined(SC32f10xx)
#    define IS_ADC_CHANNEL(CHANNEL) ((CHANNEL) <= ADC_Channel_16 || (CHANNEL) == ADC_Channel_VDD_D4)
#elif defined(SC32R803)
...
#    define IS_ADC_CHANNEL(CHANNEL)                                                                \
        ((CHANNEL) <= ADC_Channel_15 || (CHANNEL) == ADC_Channel_TEMP ||                           \
         (CHANNEL) == ADC_Channel_VDD_D4)
#elif defined(SC32R601)
#    define IS_ADC_CHANNEL(CHANNEL) ((CHANNEL) <= ADC_Channel_15 || (CHANNEL) == ADC_Channel_VDD_D4)
#endif
/**
 * @}
 */
...
#elif defined(SC32f12xx) || defined(SC32R805) || defined(SC32R806) || defined(SC32f15xx) ||        \
    defined(SC32R601)
...
#    define IS_ADC_VREF(VREF)                                                                      \
        (((VREF) == ADC_VREF_VDD) || ((VREF) == ADC_VREF_2_048V) || ((VREF) == ADC_VREF_1_024V) || \
         ((VREF) == ADC_VREF_2_4V))
#elif defined(SC32f15xx) || defined(SC32R601)
#    define IS_ADC_VREF(VREF) (((VREF) == ADC_RefSource_VDD) || ((VREF) == ADC_RefSource_VREF))
#endif
/**
 * @}
 */
...
typedef enum {
    ...
    ADC_IT_EOCIE = (uint16_t)
        ADC_IDE_EOCIE, /*!< ADC sequence 0 sampling + conversion complete interrupt Flag */
    ADC_IT_EOSIE0 = (uint16_t)
        ADC_IDE_EOSIE0, /*!< ADC sequence 0 sampling + conversion complete interrupt Flag */
...
typedef enum {
    ...
    ADC_Flag_EOSIF0 = (uint8_t)
        ADC_STS_EOSIF0, /*!< ADC sequence 0 sampling + conversion complete interrupt Flag */
