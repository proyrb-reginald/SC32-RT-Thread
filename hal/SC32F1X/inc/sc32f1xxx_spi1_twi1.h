...
typedef enum {
    SPI1_DataSize_8B =
        (uint32_t)(0X00U << SPI1_CON_SPMD_Pos), /*!< SPI Data Size:Set data frame format to 8bit */
    SPI1_DataSize_16B =
        (uint32_t)(0X01U << SPI1_CON_SPMD_Pos), /*!< SPI Data Size:Set data frame format to 16bit */
} SPI1_DataSize_TypeDef;

#define IS_SPI1_DATASIZE(SIZE) (((SIZE) == SPI1_DataSize_8B) || ((SIZE) == SPI1_DataSize_16B))
/**
 * @}
 */
...
#define IS_SPI1_FIRSTBIT(BIT) (((BIT) == SPI1_FirstBit_MSB) || ((BIT) == SPI1_FirstBit_LSB))
/**
 * @}
 */
 ...
 */
typedef enum {
    SPI1_CPHA_1Edge = (uint32_t)(0X00U << SPI1_CON_CPHA_Pos), /*!< SPI1 Clock Phase:The first edge
                                                                 signal is triggered   */
    SPI1_CPHA_2Edge = (uint32_t)(0X01U << SPI1_CON_CPHA_Pos), /*!< SPI1 Clock Phase:The second edge
                                                                 signal is triggered    */
} SPI1_CPHA_TypeDef;
...
typedef enum {
    SPI1_CPOL_Low =
        (uint32_t)(0X00U
                   << SPI1_CON_CPOL_Pos), /*!< SPI1 Clock Polarity:It is low in the idle state  */
    SPI1_CPOL_High =
        (uint32_t)(0X01U
                   << SPI1_CON_CPOL_Pos), /*!< SPI1 Clock Polarity:It is high in the idle state */
} SPI1_CPOL_TypeDef;
...
#define IS_SPI1_TWI1_Prescaler(PRESCALER)                                                          \
    (((PRESCALER) == SPI1_TWI1_Prescaler_1) || ((PRESCALER) == SPI1_TWI1_Prescaler_2) ||           \
     ...
     ((PRESCALER) == SPI1_TWI1_Prescaler_16) || ((PRESCALER) == SPI1_TWI1_Prescaler_32) ||         \
     ((PRESCALER) == SPI1_TWI1_Prescaler_64) || ((PRESCALER) == SPI1_TWI1_Prescaler_128) ||        \
     ((PRESCALER) == SPI1_TWI1_Prescaler_256) || ((PRESCALER) == SPI1_TWI1_Prescaler_512) ||       \
     ((PRESCALER) == SPI1_TWI1_Prescaler_1024) || ((PRESCALER) == SPI1_TWI1_Prescaler_2048) ||     \
...
#define IS_TWI1_GENERALCALL(GENERALCALL)                                                           \
    (((GENERALCALL) == TWI1_GeneralCall_Disable) || ((GENERALCALL) == TWI1_GeneralCall_Enable))
/**
 * @}
 */
...
typedef enum {
    ...
    SPI1_TWI1_PinRemap_A =
        (uint32_t)(0x01 << SPI1_TWI1_CON_SPOS_Pos), /*!< SPI1_TWI1 Pin Remap: Remap mode A */
    SPI1_TWI1_PinRemap_B =
        (uint32_t)(0x02 << SPI1_TWI1_CON_SPOS_Pos), /*!< SPI1_TWI1 Pin Remap: Remap mode B */
    SPI1_TWI1_PinRemap_C =
        (uint32_t)(0x03 << SPI1_TWI1_CON_SPOS_Pos), /*!< SPI1_TWI1 Pin Remap: Remap mode C */
...
#define IS_SPI1_DMAReq(DMAREQ) (((DMAREQ) == SPI1_DMAReq_RX) || ((DMAREQ) == SPI1_DMAReq_TX))
/**
 * @}
 */
...
#define IS_SPI1_FLAG(FLAG)                                                                         \
    (((FLAG) == SPI1_FLAG_QTWIF) || ((FLAG) == SPI1_FLAG_TXEIF) || ((FLAG) == SPI1_FLAG_WCOL))
...
#define IS_TWI1_FLAG(FLAG)                                                                         \
    (((FLAG) == TWI1_FLAG_QTWIF) || ((FLAG) == TWI1_FLAG_TXRXnE) || ((FLAG) == TWI1_FLAG_GCA))
/**
 * @}
 */
