...
typedef enum {
    PGA_INSEL_PGAI0 =
        (uint16_t)(0x00U << PGA_CON_PGAINSEL_Pos), /*!< The current PGA signal input is PGAI0 */
    PGA_INSEL_PGAI1 =
        (uint16_t)(0x01U << PGA_CON_PGAINSEL_Pos), /*!< The current PGA signal input is PGAI1  */
} PGA_INSEL_TypeDef;
...
typedef enum {
    ...
    PGA_GAN_NonInvert20 =
        (uint16_t)(0x00U << PGA_CON_PGAGAN_Pos), /*!< The PGA in-phase input gain is 20 times  */
    PGA_GAN_NonInvert100 =
        (uint16_t)(0x01U << PGA_CON_PGAGAN_Pos), /*!< The PGA in-phase input gain is 100 times  */
} PGA_GAN_TypeDef;
...
typedef struct {
    uint16_t
        PGA_INSEL; /*!< This member configures PGA .
                                         This parameter can be a value of @ref PGA_INSEL_TypeDef. */

    uint16_t
        PGA_COM; /*!< This member configures PGA common-mode voltage.
                                       This parameter can be a value of @ref PGA_COM_TypeDef. */

    uint16_t
        PGA_GAN; /*!< This member configures PGA input gain.
