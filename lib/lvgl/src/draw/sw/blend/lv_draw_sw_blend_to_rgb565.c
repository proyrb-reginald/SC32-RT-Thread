...
al88_image_blend(lv_draw_sw_blend_image_dsc_t * dsc);
#        endif

#        if LV_DRAW_SW_SUPPORT_I1
static void /* LV_ATTRIBUTE_FAST_MEM */
i1_image_blend(lv_draw_sw_blend_image_dsc_t * dsc);

static inline uint8_t /* LV_ATTRIBUTE_FAST_MEM */ get_bit(const uint8_t * buf,
                                                          int32_t         bit_idx);
#        endif

#        if LV_DRAW_SW_SUPPORT_L8
static void /* LV_ATTRIBUTE_FAST_MEM */
l8_image_blend(lv_draw_sw_blend_image_dsc_t * dsc);
#        endif

static void /* LV_ATTRIBUTE_FAST_MEM */
rgb565_image_blend(lv_draw_sw_blend_image_dsc_t * dsc);

#        if LV_DRAW_SW_SUPPORT_RGB565_SWAPPED
static void /* LV_ATTRIBUTE_FAST_MEM */
rgb565_swapped_image_blend(lv_draw_sw_blend_image_dsc_t * dsc);
#        endif

#        if LV_DRAW_SW_SUPPORT_RGB888 || LV_DRAW_SW_SUPPORT_XRGB8888
static void /* LV_ATTRIBUTE_FAST_MEM */
rgb888_image_blend(lv_draw_sw_blend_image_dsc_t * dsc, const uint8_t src_px_size);
#        endif

#        if LV_DRAW_SW_SUPPORT_ARGB8888
static void /* LV_ATTRIBUTE_FAST_MEM */
argb8888_image_blend(lv_draw_sw_blend_image_dsc_t * dsc);
#        endif

#        if LV_DRAW_SW_SUPPORT_ARGB8888_PREMULTIPLIED
static void /* LV_ATTRIBUTE_FAST_MEM */
argb8888_premultiplied_image_blend(lv_draw_sw_blend_image_dsc_t * dsc);
#        endif

static inline uint16_t /* LV_ATTRIBUTE_FAST_MEM */ l8_to_rgb565(const uint8_t c1);

static inline uint16_t /* LV_ATTRIBUTE_FAST_MEM */
lv_color_8_16_mix(const uint8_t c1, uint16_t c2, uint8_t mix);

static inline uint16_t /* LV_ATTRIBUTE_FAST_MEM */
lv_color_24_16_mix(const uint8_t * c1, uint16_t c2, uint8_t mix);

static inline void * /* LV_ATTRIBUTE_FAST_MEM */ drawbuf_next_row(const void * buf,
                                                                  uint32_t     stride);
...
#            define LV_DRAW_SW_AL88_BLEND_NORMAL_TO_RGB565_WITH_MASK(...)                \
                LV_RESULT_INVALID
#        endif
...
#            define LV_DRAW_SW_RGB565_BLEND_NORMAL_TO_RGB565_WITH_OPA(...)               \
                LV_RESULT_INVALID
#        endif

#        ifndef LV_DRAW_SW_RGB565_BLEND_NORMAL_TO_RGB565_WITH_MASK
#            define LV_DRAW_SW_RGB565_BLEND_NORMAL_TO_RGB565_WITH_MASK(...)              \
                LV_RESULT_INVALID
#        endif

#        ifndef LV_DRAW_SW_RGB565_BLEND_NORMAL_TO_RGB565_MIX_MASK_OPA
#            define LV_DRAW_SW_RGB565_BLEND_NORMAL_TO_RGB565_MIX_MASK_OPA(...)           \
                LV_RESULT_INVALID
#        endif
...
#            define LV_DRAW_SW_RGB888_BLEND_NORMAL_TO_RGB565_WITH_OPA(...)               \
                LV_RESULT_INVALID
#        endif

#        ifndef LV_DRAW_SW_RGB888_BLEND_NORMAL_TO_RGB565_WITH_MASK
#            define LV_DRAW_SW_RGB888_BLEND_NORMAL_TO_RGB565_WITH_MASK(...)              \
                LV_RESULT_INVALID
#        endif

#        ifndef LV_DRAW_SW_RGB888_BLEND_NORMAL_TO_RGB565_MIX_MASK_OPA
#            define LV_DRAW_SW_RGB888_BLEND_NORMAL_TO_RGB565_MIX_MASK_OPA(...)           \
                LV_RESULT_INVALID
#        endif
...
#            define LV_DRAW_SW_ARGB8888_BLEND_NORMAL_TO_RGB565_WITH_MASK(...)            \
                LV_RESULT_INVALID
#        endif

#        ifndef LV_DRAW_SW_ARGB8888_BLEND_NORMAL_TO_RGB565_MIX_MASK_OPA
#            define LV_DRAW_SW_ARGB8888_BLEND_NORMAL_TO_RGB565_MIX_MASK_OPA(...)         \
                LV_RESULT_INVALID
#        endif

#        ifndef LV_DRAW_SW_ARGB8888_PREMULTIPLIED_BLEND_NORMAL_TO_RGB565
#            define LV_DRAW_SW_ARGB8888_PREMULTIPLIED_BLEND_NORMAL_TO_RGB565(...)        \
                LV_RESULT_INVALID
#        endif
...
#            define LV_DRAW_SW_I1_BLEND_NORMAL_TO_RGB565_MIX_MASK_OPA(...)               \
                LV_RESULT_INVALID
#        endif
 ...
 * Supports normal fill, fill with opacity, fill with mask, and fill with mask and
 * opacity. dest_buf and color have native color depth. (RGB565, RGB888, XRGB8888) The
 * background (dest_buf) cannot have alpha channel
 * @param dest_buf
 * @param dest_area
 * @param dest_stride
 * @param color
...
lv_draw_sw_blend_color_to_rgb565(lv_draw_sw_blend_fill_dsc_t * dsc) {
    ...
    if (mask == NULL && opa >= LV_OPA_MAX) {
        if (LV_RESULT_INVALID == LV_DRAW_SW_COLOR_BLEND_TO_RGB565(dsc)) {
            for (y = 0; y < h; y++) {
                ...
                uint32_t * dest_end_mid =
                    (uint32_t *)((uint16_t *)dest_buf_u16 + ((w - 1) & ~(0xF)));
    ...
    /*Opacity only*/
        ...
        if (LV_RESULT_INVALID == LV_DRAW_SW_COLOR_BLEND_TO_RGB565_WITH_OPA(dsc)) {
            uint32_t last_dest32_color =
                dest_buf_u16[0] +
                1; /*Set to value which is not equal to the first pixel*/
            ...
            for (y = 0; y < h; y++) {
                ...
                for (; x < w - 2; x += 2) {
                    if (dest_buf_u16[x] != dest_buf_u16[x + 1]) {
                        dest_buf_u16[x + 0] =
                            lv_color_16_16_mix(color16, dest_buf_u16[x + 0], opa);
                        dest_buf_u16[x + 1] =
                            lv_color_16_16_mix(color16, dest_buf_u16[x + 1], opa);
                    } else {
        ...
        if (LV_RESULT_INVALID == LV_DRAW_SW_COLOR_BLEND_TO_RGB565_WITH_MASK(dsc)) {
            for (y = 0; y < h; y++) {
                ...
                if ((lv_uintptr_t)(mask) & 0x1) {
                    dest_buf_u16[x] =
                        lv_color_16_16_mix(color16, dest_buf_u16[x], mask[x]);
                    x++;
                }
                ...
                for (; x <= w - 2; x += 2) {
                    ...
                    if (mask16 == 0xFFFF) {
                        ...
                        dest_buf_u16[x + 0] =
                            lv_color_16_16_mix(color16, dest_buf_u16[x + 0], mask[x + 0]);
                        dest_buf_u16[x + 1] =
                            lv_color_16_16_mix(color16, dest_buf_u16[x + 1], mask[x + 1]);
                    }
                }
    ...
    /*Masked with opacity*/
        ...
        if (LV_RESULT_INVALID == LV_DRAW_SW_COLOR_BLEND_TO_RGB565_MIX_MASK_OPA(dsc)) {
            for (y = 0; y < h; y++) {
                for (x = 0; x < w; x++) {
                    dest_buf_u16[x] = lv_color_16_16_mix(color16, dest_buf_u16[x],
                                                         LV_OPA_MIX2(mask[x], opa));
                }
                dest_buf_u16 = drawbuf_next_row(dest_buf_u16, dest_stride);
                mask += mask_stride;
            }
...
void LV_ATTRIBUTE_FAST_MEM
lv_draw_sw_blend_image_to_rgb565(lv_draw_sw_blend_image_dsc_t * dsc) {
    switch (dsc->src_color_format) {
        case LV_COLOR_FORMAT_RGB565: rgb565_image_blend(dsc); break;
#        if LV_DRAW_SW_SUPPORT_RGB565_SWAPPED
        case LV_COLOR_FORMAT_RGB565_SWAPPED: rgb565_swapped_image_blend(dsc); break;
#        endif
#        if LV_DRAW_SW_SUPPORT_RGB888
        case LV_COLOR_FORMAT_RGB888: rgb888_image_blend(dsc, 3); break;
#        endif
#        if LV_DRAW_SW_SUPPORT_XRGB8888
        case LV_COLOR_FORMAT_XRGB8888: rgb888_image_blend(dsc, 4); break;
#        endif
#        if LV_DRAW_SW_SUPPORT_ARGB8888
        case LV_COLOR_FORMAT_ARGB8888: argb8888_image_blend(dsc); break;
#        endif
#        if LV_DRAW_SW_SUPPORT_ARGB8888_PREMULTIPLIED
...
#        endif
#        if LV_DRAW_SW_SUPPORT_L8
        case LV_COLOR_FORMAT_L8: l8_image_blend(dsc); break;
#        endif
#        if LV_DRAW_SW_SUPPORT_AL88
        case LV_COLOR_FORMAT_AL88: al88_image_blend(dsc); break;
#        endif
#        if LV_DRAW_SW_SUPPORT_I1
        case LV_COLOR_FORMAT_I1: i1_image_blend(dsc); break;
#        endif
        default:
    ...
    if (dsc->blend_mode == LV_BLEND_MODE_NORMAL) {
        if (mask_buf == NULL && opa >= LV_OPA_MAX) {
            ...
            if (LV_RESULT_INVALID == LV_DRAW_SW_I1_BLEND_NORMAL_TO_RGB565_WITH_OPA(dsc)) {
                for (y = 0; y < h; y++) {
                    for (dest_x = 0, src_x = 0; dest_x < w; dest_x++, src_x++) {
                        uint8_t chan_val = get_bit(src_buf_i1, src_x) * 255;
                        dest_buf_u16[dest_x] =
                            lv_color_8_16_mix(chan_val, dest_buf_u16[dest_x], opa);
                    }
                    dest_buf_u16 = drawbuf_next_row(dest_buf_u16, dest_stride);
                    src_buf_i1   = drawbuf_next_row(src_buf_i1, src_stride);
                }
            ...
            if (LV_RESULT_INVALID ==
                LV_DRAW_SW_I1_BLEND_NORMAL_TO_RGB565_WITH_MASK(dsc)) {
                for (y = 0; y < h; y++) {
                    for (dest_x = 0, src_x = 0; dest_x < w; dest_x++, src_x++) {
                        uint8_t chan_val     = get_bit(src_buf_i1, src_x) * 255;
                        dest_buf_u16[dest_x] = lv_color_8_16_mix(
                            chan_val, dest_buf_u16[dest_x], mask_buf[dest_x]);
                    }
                    dest_buf_u16 = drawbuf_next_row(dest_buf_u16, dest_stride);
                    src_buf_i1   = drawbuf_next_row(src_buf_i1, src_stride);
            ...
            if (LV_RESULT_INVALID ==
                LV_DRAW_SW_I1_BLEND_NORMAL_TO_RGB565_MIX_MASK_OPA(dsc)) {
                for (y = 0; y < h; y++) {
                    for (dest_x = 0, src_x = 0; dest_x < w; dest_x++, src_x++) {
                        uint8_t chan_val = get_bit(src_buf_i1, src_x) * 255;
                        dest_buf_u16[dest_x] =
                            lv_color_8_16_mix(chan_val, dest_buf_u16[dest_x],
            ...
            for (dest_x = 0, src_x = 0; dest_x < w; dest_x++, src_x += 4) {
                ...
                switch (dsc->blend_mode) {
                    case LV_BLEND_MODE_ADDITIVE:
                        ...
                        res = (LV_MIN(dest_buf_u16[dest_x] + l8_to_rgb565(chan_val),
                                      0xFFFF));
                        break;
                    ...
                    case LV_BLEND_MODE_MULTIPLY:
                        ...
                        res = ((((dest_buf_u16[dest_x] >> 11) *
                                 (l8_to_rgb565(chan_val) >> 3)) &
                                0x1F)
                               << 11) |
                              ((((dest_buf_u16[dest_x] >> 5) & 0x3F) *
                                    ((l8_to_rgb565(chan_val) >> 2) & 0x3F) >>
                                6)
                               << 5) |
                              (((dest_buf_u16[dest_x] & 0x1F) *
                                (l8_to_rgb565(chan_val) & 0x1F)) >>
                               5);
                        break;
                ...
                if (mask_buf == NULL && opa >= LV_OPA_MAX) {
                    ...
                    if (opa >= LV_OPA_MAX)
                        ...
                        dest_buf_u16[dest_x] =
                            lv_color_16_16_mix(res, dest_buf_u16[dest_x],
                                               LV_OPA_MIX2(mask_buf[dest_x], opa));
                }
            }
        ...
        if (mask_buf == NULL && opa >= LV_OPA_MAX) {
            if (LV_RESULT_INVALID == LV_DRAW_SW_AL88_BLEND_NORMAL_TO_RGB565(dsc)) {
                for (y = 0; y < h; y++) {
                    for (dest_x = 0, src_x = 0; dest_x < w; dest_x++, src_x++) {
                        dest_buf_u16[dest_x] = lv_color_8_16_mix(
                            src_buf_al88[src_x].lumi, dest_buf_u16[dest_x],
            ...
            if (LV_RESULT_INVALID ==
                LV_DRAW_SW_AL88_BLEND_NORMAL_TO_RGB565_WITH_OPA(dsc)) {
                for (y = 0; y < h; y++) {
                    for (dest_x = 0, src_x = 0; dest_x < w; dest_x++, src_x++) {
                        dest_buf_u16[dest_x] = lv_color_8_16_mix(
                            src_buf_al88[src_x].lumi, dest_buf_u16[dest_x],
            ...
            if (LV_RESULT_INVALID ==
                LV_DRAW_SW_AL88_BLEND_NORMAL_TO_RGB565_WITH_MASK(dsc)) {
                for (y = 0; y < h; y++) {
                    for (dest_x = 0, src_x = 0; dest_x < w; dest_x++, src_x++) {
                        dest_buf_u16[dest_x] = lv_color_8_16_mix(
                            src_buf_al88[src_x].lumi, dest_buf_u16[dest_x],
            ...
            if (LV_RESULT_INVALID ==
                LV_DRAW_SW_AL88_BLEND_NORMAL_TO_RGB565_MIX_MASK_OPA(dsc)) {
                for (y = 0; y < h; y++) {
                    for (dest_x = 0, src_x = 0; dest_x < w; dest_x++, src_x++) {
                        dest_buf_u16[dest_x] = lv_color_8_16_mix(
                            src_buf_al88[src_x].lumi, dest_buf_u16[dest_x],
                            LV_OPA_MIX3(src_buf_al88[src_x].alpha, mask_buf[dest_x],
                                        opa));
                    }
                    dest_buf_u16 = drawbuf_next_row(dest_buf_u16, dest_stride);
                    src_buf_al88 = drawbuf_next_row(src_buf_al88, src_stride);
        ...
        if (mask_buf == NULL && opa >= LV_OPA_MAX) {
            ...
            if (LV_RESULT_INVALID == LV_DRAW_SW_L8_BLEND_NORMAL_TO_RGB565_WITH_OPA(dsc)) {
                for (y = 0; y < h; y++) {
                    for (dest_x = 0, src_x = 0; dest_x < w; dest_x++, src_x++) {
                        dest_buf_u16[dest_x] = lv_color_8_16_mix(
                            src_buf_l8[src_x], dest_buf_u16[dest_x], opa);
                    }
                    dest_buf_u16 = drawbuf_next_row(dest_buf_u16, dest_stride);
                    src_buf_l8 += src_stride;
                }
            ...
            if (LV_RESULT_INVALID ==
                LV_DRAW_SW_L8_BLEND_NORMAL_TO_RGB565_WITH_MASK(dsc)) {
                for (y = 0; y < h; y++) {
                    for (dest_x = 0, src_x = 0; dest_x < w; dest_x++, src_x++) {
                        dest_buf_u16[dest_x] = lv_color_8_16_mix(
                            src_buf_l8[src_x], dest_buf_u16[dest_x], mask_buf[dest_x]);
                    }
                    dest_buf_u16 = drawbuf_next_row(dest_buf_u16, dest_stride);
                    src_buf_l8 += src_stride;
                    mask_buf += mask_stride;
            ...
            if (LV_RESULT_INVALID ==
                LV_DRAW_SW_L8_BLEND_NORMAL_TO_RGB565_MIX_MASK_OPA(dsc)) {
                for (y = 0; y < h; y++) {
                    for (dest_x = 0, src_x = 0; dest_x < w; dest_x++, src_x++) {
                        dest_buf_u16[dest_x] =
                            lv_color_8_16_mix(src_buf_l8[src_x], dest_buf_u16[dest_x],
                                              LV_OPA_MIX2(mask_buf[dest_x], opa));
                    }
                    dest_buf_u16 = drawbuf_next_row(dest_buf_u16, dest_stride);
                    src_buf_l8 += src_stride;
        ...
        if (mask_buf == NULL && opa >= LV_OPA_MAX) {
            ...
            if (LV_RESULT_INVALID ==
                ...
                for (y = 0; y < h; y++) {
                    for (x = 0; x < w; x++) {
                        dest_buf_u16[x] =
                            lv_color_16_16_mix(src_buf_u16[x], dest_buf_u16[x], opa);
                    }
                    dest_buf_u16 = drawbuf_next_row(dest_buf_u16, dest_stride);
                    src_buf_u16  = drawbuf_next_row(src_buf_u16, src_stride);
                }
            ...
            if (LV_RESULT_INVALID ==
                ...
                for (y = 0; y < h; y++) {
                    for (x = 0; x < w; x++) {
                        dest_buf_u16[x] = lv_color_16_16_mix(
                            src_buf_u16[x], dest_buf_u16[x], mask_buf[x]);
                    }
                    dest_buf_u16 = drawbuf_next_row(dest_buf_u16, dest_stride);
                    src_buf_u16  = drawbuf_next_row(src_buf_u16, src_stride);
                    mask_buf += mask_stride;
            ...
            if (LV_RESULT_INVALID ==
                ...
                for (y = 0; y < h; y++) {
                    for (x = 0; x < w; x++) {
                        dest_buf_u16[x] =
                            lv_color_16_16_mix(src_buf_u16[x], dest_buf_u16[x],
            ...
            for (x = 0; x < w; x++) {
                switch (dsc->blend_mode) {
                    ...
                    case LV_BLEND_MODE_MULTIPLY:
                        if (src_buf_u16[x] == 0xffff)
                            continue; /*Do not multiply with pure white (considered as
                                         1)*/
                    ...
                    case LV_BLEND_MODE_DIFFERENCE:
                        ...
                        res += (LV_ABS(dest_buf_c16[x].green - src_buf_c16[x].green))
                               << 5;
                ...
                if (mask_buf == NULL) {
                    ...
                    if (opa >= LV_OPA_MAX)
                        ...
                        dest_buf_u16[x] = lv_color_16_16_mix(
                            res, dest_buf_u16[x], LV_OPA_MIX2(mask_buf[x], opa));
                }
            }
        ...
        if (mask_buf == NULL && opa >= LV_OPA_MAX) {
            ...
            if (LV_RESULT_INVALID ==
                ...
                for (y = 0; y < h; y++) {
                    for (x = 0; x < w; x++) {
                        dest_buf_u16[x] = lv_color_16_16_mix(
                            lv_color_swap_16(src_buf_u16[x]), dest_buf_u16[x], opa);
                    }
                    dest_buf_u16 = drawbuf_next_row(dest_buf_u16, dest_stride);
                    src_buf_u16  = drawbuf_next_row(src_buf_u16, src_stride);
                }
            ...
            if (LV_RESULT_INVALID ==
                ...
                for (y = 0; y < h; y++) {
                    for (x = 0; x < w; x++) {
                        dest_buf_u16[x] =
                            lv_color_16_16_mix(lv_color_swap_16(src_buf_u16[x]),
                                               dest_buf_u16[x], mask_buf[x]);
                    }
                    dest_buf_u16 = drawbuf_next_row(dest_buf_u16, dest_stride);
                    src_buf_u16  = drawbuf_next_row(src_buf_u16, src_stride);
                    mask_buf += mask_stride;
            ...
            if (LV_RESULT_INVALID ==
                ...
                for (y = 0; y < h; y++) {
                    for (x = 0; x < w; x++) {
                        dest_buf_u16[x] = lv_color_16_16_mix(
                            lv_color_swap_16(src_buf_u16[x]), dest_buf_u16[x],
                            LV_OPA_MIX2(mask_buf[x], opa));
                    }
                    dest_buf_u16 = drawbuf_next_row(dest_buf_u16, dest_stride);
                    src_buf_u16  = drawbuf_next_row(src_buf_u16, src_stride);
    ...
    if (dsc->blend_mode == LV_BLEND_MODE_NORMAL) {
        if (mask_buf == NULL && opa >= LV_OPA_MAX) {
            if (LV_RESULT_INVALID ==
                ...
                for (y = 0; y < h; y++) {
                    for (dest_x = 0, src_x = 0; dest_x < w;
                         dest_x++, src_x += src_px_size) {
            ...
            if (LV_RESULT_INVALID ==
                ...
                for (y = 0; y < h; y++) {
                    for (dest_x = 0, src_x = 0; dest_x < w;
                         dest_x++, src_x += src_px_size) {
                        dest_buf_u16[dest_x] = lv_color_24_16_mix(
                            &src_buf_u8[src_x], dest_buf_u16[dest_x], opa);
                    }
                    dest_buf_u16 = drawbuf_next_row(dest_buf_u16, dest_stride);
                    src_buf_u8 += src_stride;
                }
            ...
            if (LV_RESULT_INVALID ==
                ...
                for (y = 0; y < h; y++) {
                    for (dest_x = 0, src_x = 0; dest_x < w;
                         dest_x++, src_x += src_px_size) {
                        dest_buf_u16[dest_x] = lv_color_24_16_mix(
                            &src_buf_u8[src_x], dest_buf_u16[dest_x], mask_buf[dest_x]);
                    }
                    dest_buf_u16 = drawbuf_next_row(dest_buf_u16, dest_stride);
                    src_buf_u8 += src_stride;
                    mask_buf += mask_stride;
        ...
        for (y = 0; y < h; y++) {
            ...
            for (dest_x = 0, src_x = 0; dest_x < w; dest_x++, src_x += src_px_size) {
                switch (dsc->blend_mode) {
                    case LV_BLEND_MODE_ADDITIVE:
                        res = (LV_MIN(dest_buf_c16[dest_x].red +
                                          (src_buf_u8[src_x + 2] >> 3),
                                      31))
                              << 11;
                        res += (LV_MIN(dest_buf_c16[dest_x].green +
                                           (src_buf_u8[src_x + 1] >> 2),
                                       63))
                               << 5;
                        res += LV_MIN(
                            dest_buf_c16[dest_x].blue + (src_buf_u8[src_x + 0] >> 3), 31);
                        break;
                    case LV_BLEND_MODE_SUBTRACTIVE:
                        res = (LV_MAX(dest_buf_c16[dest_x].red -
                                          (src_buf_u8[src_x + 2] >> 3),
                                      0))
                              << 11;
                        res += (LV_MAX(dest_buf_c16[dest_x].green -
                                           (src_buf_u8[src_x + 1] >> 2),
                                       0))
                               << 5;
                        res += LV_MAX(
                            dest_buf_c16[dest_x].blue - (src_buf_u8[src_x + 0] >> 3), 0);
                        break;
                    case LV_BLEND_MODE_MULTIPLY:
                        res =
                            ((dest_buf_c16[dest_x].red * (src_buf_u8[src_x + 2] >> 3)) >>
                             5)
                            << 11;
                        res += ((dest_buf_c16[dest_x].green *
                                 (src_buf_u8[src_x + 1] >> 2)) >>
                                6)
                               << 5;
                        res +=
                            (dest_buf_c16[dest_x].blue * (src_buf_u8[src_x + 0] >> 3)) >>
                            5;
                        break;
                    case LV_BLEND_MODE_DIFFERENCE:
                        res = (LV_ABS(dest_buf_c16[dest_x].red -
                                      (src_buf_u8[src_x + 2] >> 3)))
                              << 11;
                        res += (LV_ABS(dest_buf_c16[dest_x].green -
                                       (src_buf_u8[src_x + 1] >> 2)))
                               << 5;
                        res += LV_ABS(dest_buf_c16[dest_x].blue -
                                      (src_buf_u8[src_x + 0] >> 3));
                        break;
                    default:
                        LV_LOG_WARN("Not supported blend mode: %d", dsc->blend_mode);
                        return;
        ...
        if (mask_buf == NULL && opa >= LV_OPA_MAX) {
            ...
            if (LV_RESULT_INVALID ==
                ...
                for (y = 0; y < h; y++) {
                    for (dest_x = 0, src_x = 0; dest_x < w; dest_x++, src_x += 4) {
                        dest_buf_u16[dest_x] = lv_color_24_16_mix(
                            &src_buf_u8[src_x], dest_buf_u16[dest_x],
            ...
            for (dest_x = 0, src_x = 0; dest_x < w; dest_x++, src_x += 4) {
                ...
                if (mask_buf == NULL && opa >= LV_OPA_MAX) {
                    ...
                    if (opa >= LV_OPA_MAX)
                        ...
                        dest_buf_u16[dest_x] = lv_color_16_16_mix(
                            res, dest_buf_u16[dest_x],
                            LV_OPA_MIX3(mask_buf[dest_x], opa, src_buf_u8[src_x + 3]));
                }
            }
...
static inline uint16_t LV_ATTRIBUTE_FAST_MEM
lv_color_24_16_mix_premult(const uint8_t * c1, uint16_t c2, uint8_t mix) {
    if (mix == 0) {
        return c2;
    } else if (mix == 255) {
...
argb8888_premultiplied_image_blend(lv_draw_sw_blend_image_dsc_t * dsc) {
    ...
    if (dsc->blend_mode == LV_BLEND_MODE_NORMAL) {
        if (mask_buf == NULL && opa >= LV_OPA_MAX) {
            if (LV_RESULT_INVALID ==
                LV_DRAW_SW_ARGB8888_PREMULTIPLIED_BLEND_NORMAL_TO_RGB565(dsc)) {
                for (y = 0; y < h; y++) {
                    for (dest_x = 0, src_x = 0; dest_x < w; dest_x++, src_x += 4) {
                        /*For the trivial case use the premultipled image as it is.
                         *For the other cases unpremultiply as another alpha also needs to
                         *be applied.*/
            ...
            if (LV_RESULT_INVALID ==
                LV_DRAW_SW_ARGB8888_PREMULTIPLIED_BLEND_NORMAL_TO_RGB565_WITH_OPA(dsc)) {
                for (y = 0; y < h; y++) {
                    for (dest_x = 0, src_x = 0; dest_x < w; dest_x++, src_x += 4) {
                        if (src_buf_u8[src_x + 3] > 0) {
                            uint8_t  src_buf_u8_unpremult[3];
                            uint16_t reciprocal = (255 * 256) / src_buf_u8[src_x + 3];
                            src_buf_u8_unpremult[0] =
                                (src_buf_u8[src_x + 0] * reciprocal) >> 8;
                            src_buf_u8_unpremult[1] =
                                (src_buf_u8[src_x + 1] * reciprocal) >> 8;
                            src_buf_u8_unpremult[2] =
                                (src_buf_u8[src_x + 2] * reciprocal) >> 8;
                            dest_buf_u16[dest_x] = lv_color_24_16_mix(
                                src_buf_u8_unpremult, dest_buf_u16[dest_x],
                                LV_OPA_MIX2(src_buf_u8[src_x + 3], opa));
                        }
                    }
                    dest_buf_u16 = drawbuf_next_row(dest_buf_u16, dest_stride);
            ...
            if (LV_RESULT_INVALID ==
                LV_DRAW_SW_ARGB8888_PREMULTIPLIED_BLEND_NORMAL_TO_RGB565_WITH_MASK(dsc)) {
                for (y = 0; y < h; y++) {
                    for (dest_x = 0, src_x = 0; dest_x < w; dest_x++, src_x += 4) {
                        if (src_buf_u8[src_x + 3] > 0) {
                            uint8_t  src_buf_u8_unpremult[3];
                ...
                for (y = 0; y < h; y++) {
                    for (dest_x = 0, src_x = 0; dest_x < w; dest_x++, src_x += 4) {
                        if (src_buf_u8[src_x + 3] > 0) {
                            ...
                            dest_buf_u16[dest_x] = lv_color_24_16_mix(
                                src_buf_u8_unpremult, dest_buf_u16[dest_x],
                                LV_OPA_MIX3(src_buf_u8[src_x + 3], mask_buf[dest_x],
                                            opa));
                        }
                    }
                    dest_buf_u16 = drawbuf_next_row(dest_buf_u16, dest_stride);
        ...
        for (y = 0; y < h; y++) {
            ...
            for (dest_x = 0, src_x = 0; dest_x < w; dest_x++, src_x += 4) {
                ...
                if (mask_buf == NULL && opa >= LV_OPA_MAX) {
                    /* Blending premultiplied ARGB8888 to RGB565 with no mask and full
                     * opacity */
                    dest_buf_u16[dest_x] = lv_color_16_16_mix(res, dest_buf_u16[dest_x],
                                                              src_buf_u8[src_x + 3]);
                } else if (mask_buf == NULL && opa < LV_OPA_MAX) {
                    /* Blending premultiplied ARGB8888 to RGB565 with no mask and partial
                     * opacity */
                    dest_buf_u16[dest_x] =
                        lv_color_16_16_mix(res, dest_buf_u16[dest_x],
                                           LV_OPA_MIX2(opa, src_buf_u8[src_x + 3]));
...
static inline uint16_t LV_ATTRIBUTE_FAST_MEM lv_color_8_16_mix(const uint8_t c1,
                                                               uint16_t      c2,
                                                               uint8_t       mix) {
    if (mix == 0) {
        return c2;
...
static inline uint16_t LV_ATTRIBUTE_FAST_MEM lv_color_24_16_mix(const uint8_t * c1,
                                                                uint16_t        c2,
                                                                uint8_t         mix) {
    if (mix == 0) {
        return c2;
