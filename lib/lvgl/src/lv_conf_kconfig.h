/** * @file lv_conf_kconfig.h * Configs that need special handling when LVGL is used with
 * Kconfig */
 ...
 * Mismatch can happen when user manually copy lvgl/Kconfig file to their project, like
 * what NuttX does.
 */
#        include "../lv_version.h"

#        if CONFIG_LVGL_VERSION_MAJOR != LVGL_VERSION_MAJOR ||                           \
            CONFIG_LVGL_VERSION_MINOR != LVGL_VERSION_MINOR ||                           \
...
#    define CONFIG_LV_MEM_POOL_EXPAND_SIZE                                               \
        (CONFIG_LV_MEM_POOL_EXPAND_SIZE_KILOBYTES * 1024U)
#endif
...
#        define CONFIG_LV_CALENDAR_DEFAULT_DAY_NAMES                                     \
            {CONFIG_LV_MONDAY_STR,   CONFIG_LV_TUESDAY_STR, CONFIG_LV_WEDNESDAY_STR,     \
             CONFIG_LV_THURSDAY_STR, CONFIG_LV_FRIDAY_STR,  CONFIG_LV_SATURDAY_STR,      \
             CONFIG_LV_SUNDAY_STR}
#    else
#        define CONFIG_LV_CALENDAR_DEFAULT_DAY_NAMES                                     \
            {CONFIG_LV_SUNDAY_STR,    CONFIG_LV_MONDAY_STR,   CONFIG_LV_TUESDAY_STR,     \
             CONFIG_LV_WEDNESDAY_STR, CONFIG_LV_THURSDAY_STR, CONFIG_LV_FRIDAY_STR,      \
             CONFIG_LV_SATURDAY_STR}
#    endif
#endif
